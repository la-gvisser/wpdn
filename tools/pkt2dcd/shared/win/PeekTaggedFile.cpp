...
//	PeekTaggedFile.cpp
// =============================================================================
//	Copyright (c) 2003-2007 WildPackets, Inc. All rights reserved.
	...
	bool	/*bIsCompressed*/ )
{
	...
	UInt8	gz_magic[2];
	DWORD	dwRead;
	if ( !::ReadFile( hFile, gz_magic, 2, &dwRead, NULL ) )
	{
		return false;
	}
	...
	if ( (gz_magic[0] == 0x1f) && (gz_magic[1] == 0x8b) )
	{
		...
		m_hCompressedFile = gzopen( CT2CA(lpszFile), "rb" );
		if ( m_hCompressedFile == NULL )
		{
			m_nResult = ::GetLastError();
			return false;
	...
	time_t	t )
{
	...
	if ( pTm != NULL )
	{
		_tcsftime( m_strTime.GetBuffer( 256 ), 256, _T("%Y-%m-%dT%H:%M:%SZ"), pTm );
...
CCaptureFileSessionBlock::SetSessionStartTime(
	UInt64	t )
{
	if ( (t == 0) || (t == PeekTimeStamp::kTimeStamp_Invalid) )
	{
		m_strSessionStartTime.Empty();
	}
	else
	{
		TimeStampFormat::TimeStampToISO8601String( t,
			TimeStampFormat::kFormat_Nanoseconds,
			m_strSessionStartTime.GetBuffer( 256 ), 256 );
...
{
	UInt64	ts = 0;
	TimeStampFormat::ISO8601StringToTimeStamp( m_strSessionStartTime, &ts );
	return ts;
}
	...
	UInt64	t )
{
	...
	else
	{
		TimeStampFormat::TimeStampToISO8601String( t,
			TimeStampFormat::kFormat_Nanoseconds,
			m_strSessionEndTime.GetBuffer( 256 ), 256 );
...
{
	UInt64	ts = 0;
	TimeStampFormat::ISO8601StringToTimeStamp( m_strSessionEndTime, &ts );
	return ts;
}
	...
	DWORD*				outBytesWritten )
{
	if ( !m_bWroteHeader )
	{
		...
		// init the tunnel header
		m_tunneledWirelessHeader.channelNumber.fieldType = Attrib_ChannelNumber; 
		m_tunneledWirelessHeader.channelFreq.fieldType = Attrib_ChannelFreq; 
		m_tunneledWirelessHeader.channelBand.fieldType = Attrib_ChannelBand; 
		m_tunneledWirelessHeader.dataRate.fieldType = Attrib_DataRate;
		m_tunneledWirelessHeader.signalStrength.fieldType = Attrib_SignalStrength;
		m_tunneledWirelessHeader.signaldBm.fieldType = Attrib_SignaldBm;
		m_tunneledWirelessHeader.signaldBm1.fieldType = Attrib_SignaldBm1;
		m_tunneledWirelessHeader.signaldBm2.fieldType = Attrib_SignaldBm2;
		m_tunneledWirelessHeader.signaldBm3.fieldType = Attrib_SignaldBm3;
		m_tunneledWirelessHeader.noiseStrength.fieldType = Attrib_NoiseStrength;
		m_tunneledWirelessHeader.noisedBm.fieldType = Attrib_NoisedBm;
		m_tunneledWirelessHeader.noisedBm1.fieldType = Attrib_NoisedBm1;
		m_tunneledWirelessHeader.noisedBm2.fieldType = Attrib_NoisedBm2;
		m_tunneledWirelessHeader.noisedBm3.fieldType = Attrib_NoisedBm3;
		m_tunneledWirelessHeader.flagsN.fieldType = Attrib_FlagsN;
		m_tunneledWirelessHeader.signaldBm4.fieldType = Attrib_SignaldBm4;
		m_tunneledWirelessHeader.noisedBm4.fieldType = Attrib_NoisedBm4;
		m_tunneledWirelessHeader.accessPointAddress1.fieldType = Attrib_AccessPointAddress1;
		m_tunneledWirelessHeader.accessPointAddress2.fieldType = Attrib_AccessPointAddress2;
		m_tunneledWirelessHeader.accessPointAddress3.fieldType = Attrib_AccessPointAddress3;
		m_tunneledWirelessHeader.accessPointAddress4.fieldType = Attrib_AccessPointAddress4;
		m_tunneledWirelessHeader.collectorPort.fieldType = Attrib_RemoteAPCollectorPort;
	...
	DWORD*				outBytesWritten )
{
	...
	if (pHdr)
	{
		...
		switch (pHdr->nType)
		{
			...
			{
				const TunneledWirelessHeader*	pRemoteAP = 
					reinterpret_cast<const TunneledWirelessHeader*>
						(pPacket->fMediaSpecInfoBlock + sizeof(MediaSpecificPrivateHeader));
				m_tunneledWirelessHeader.channelNumber.fieldValue    = pRemoteAP->Wireless.Channel.Channel;
				m_tunneledWirelessHeader.channelFreq.fieldValue      = pRemoteAP->Wireless.Channel.Frequency;
				m_tunneledWirelessHeader.channelBand.fieldValue      = pRemoteAP->Wireless.Channel.Band;
				m_tunneledWirelessHeader.dataRate.fieldValue         = pRemoteAP->Wireless.DataRate;
				m_tunneledWirelessHeader.signalStrength.fieldValue   = pRemoteAP->Wireless.SignalPercent;
				m_tunneledWirelessHeader.signaldBm.fieldValue        = pRemoteAP->Wireless.SignaldBm;
				m_tunneledWirelessHeader.signaldBm1.fieldValue       = pRemoteAP->Wireless.SignaldBm1;
				m_tunneledWirelessHeader.signaldBm2.fieldValue       = pRemoteAP->Wireless.SignaldBm2;
				m_tunneledWirelessHeader.signaldBm3.fieldValue       = pRemoteAP->Wireless.SignaldBm3;
				m_tunneledWirelessHeader.noiseStrength.fieldValue    = pRemoteAP->Wireless.NoisePercent;
				m_tunneledWirelessHeader.noisedBm.fieldValue         = pRemoteAP->Wireless.NoisedBm;
				m_tunneledWirelessHeader.noisedBm1.fieldValue        = pRemoteAP->Wireless.NoisedBm1;
				m_tunneledWirelessHeader.noisedBm2.fieldValue        = pRemoteAP->Wireless.NoisedBm2;
				m_tunneledWirelessHeader.noisedBm3.fieldValue        = pRemoteAP->Wireless.NoisedBm3;
				m_tunneledWirelessHeader.flagsN.fieldValue           = pRemoteAP->Wireless.FlagsN;
				m_tunneledWirelessHeader.signaldBm4.fieldValue       = pRemoteAP->SignaldBm4;
				m_tunneledWirelessHeader.noisedBm4.fieldValue        = pRemoteAP->NoisedBm4;
				if ( pRemoteAP->SenderAddress.Type == PEEK_IP_ADDRESS_TYPE_V4 )
				{
					m_tunneledWirelessHeader.accessPointAddress1.fieldValue = pRemoteAP->SenderAddress.ipv4;
					m_tunneledWirelessHeader.accessPointAddress2.fieldValue = 0;
					m_tunneledWirelessHeader.accessPointAddress3.fieldValue = 0;
					m_tunneledWirelessHeader.accessPointAddress4.fieldValue = 0;
				}
				else if ( pRemoteAP->SenderAddress.Type == PEEK_IP_ADDRESS_TYPE_V6 )
				{
					m_tunneledWirelessHeader.accessPointAddress1.fieldValue = 
						(static_cast<UInt32>(pRemoteAP->SenderAddress.ipv6[0]) << 24) |
						(static_cast<UInt32>(pRemoteAP->SenderAddress.ipv6[1]) << 16) |
						(static_cast<UInt32>(pRemoteAP->SenderAddress.ipv6[2]) << 8) |
						static_cast<UInt32>(pRemoteAP->SenderAddress.ipv6[3]);
					m_tunneledWirelessHeader.accessPointAddress2.fieldValue = 
						(static_cast<UInt32>(pRemoteAP->SenderAddress.ipv6[4]) << 24) |
						(static_cast<UInt32>(pRemoteAP->SenderAddress.ipv6[5]) << 16) |
						(static_cast<UInt32>(pRemoteAP->SenderAddress.ipv6[6]) << 8) |
						static_cast<UInt32>(pRemoteAP->SenderAddress.ipv6[7]);
					m_tunneledWirelessHeader.accessPointAddress3.fieldValue =
						(static_cast<UInt32>(pRemoteAP->SenderAddress.ipv6[8]) << 24) |
						(static_cast<UInt32>(pRemoteAP->SenderAddress.ipv6[9]) << 16) |
						(static_cast<UInt32>(pRemoteAP->SenderAddress.ipv6[10]) << 8) |
						static_cast<UInt32>(pRemoteAP->SenderAddress.ipv6[11]);
					m_tunneledWirelessHeader.accessPointAddress4.fieldValue = 
						(static_cast<UInt32>(pRemoteAP->SenderAddress.ipv6[12]) << 24) |
						(static_cast<UInt32>(pRemoteAP->SenderAddress.ipv6[13]) << 16) |
						(static_cast<UInt32>(pRemoteAP->SenderAddress.ipv6[14]) << 8) |
						static_cast<UInt32>(pRemoteAP->SenderAddress.ipv6[15]);
				}
				else
				{
					m_tunneledWirelessHeader.accessPointAddress1.fieldValue = 0;
					m_tunneledWirelessHeader.accessPointAddress2.fieldValue = 0;
					m_tunneledWirelessHeader.accessPointAddress3.fieldValue = 0;
					m_tunneledWirelessHeader.accessPointAddress4.fieldValue = 0;
				}
				m_tunneledWirelessHeader.collectorPort.fieldValue    = pRemoteAP->ReceiverPort;
				if ( outBytesWritten )
					*outBytesWritten += sizeof(m_tunneledWirelessHeader);
				if (!theFile.WriteBytes(&m_tunneledWirelessHeader, sizeof(m_tunneledWirelessHeader)))
					return false;
				break;
			}
			default:
		...
		switch (theAttrib.fieldType)
		{
			...
			case Attrib_MediaSpecType:
				...
				switch ( m_mediaInfo.StdHeader.nType )
				{
					...
					case kMediaSpecificHdrType_TunneledWireless:
						// set the size
						m_mediaInfo.StdHeader.nSize = sizeof(MediaSpecificPrivateHeader) + sizeof(TunneledWirelessHeader);
						// init the header
						memset( &m_mediaInfo.MediaInfo.tunneledWireless, 0, sizeof(TunneledWirelessHeader) );
						m_mediaInfo.MediaInfo.tunneledWireless.Wireless.SignaldBm  = PEEK_NULL_DBM;
						m_mediaInfo.MediaInfo.tunneledWireless.Wireless.SignaldBm1 = PEEK_NULL_DBM; 
						m_mediaInfo.MediaInfo.tunneledWireless.Wireless.SignaldBm2 = PEEK_NULL_DBM; 
						m_mediaInfo.MediaInfo.tunneledWireless.Wireless.SignaldBm3 = PEEK_NULL_DBM;
						m_mediaInfo.MediaInfo.tunneledWireless.Wireless.NoisedBm   = PEEK_NULL_DBM;
						m_mediaInfo.MediaInfo.tunneledWireless.Wireless.NoisedBm1  = PEEK_NULL_DBM;
						m_mediaInfo.MediaInfo.tunneledWireless.Wireless.NoisedBm2  = PEEK_NULL_DBM;
						m_mediaInfo.MediaInfo.tunneledWireless.Wireless.NoisedBm3  = PEEK_NULL_DBM;
						m_mediaInfo.MediaInfo.tunneledWireless.SignaldBm4          = PEEK_NULL_DBM;
						m_mediaInfo.MediaInfo.tunneledWireless.NoisedBm4           = PEEK_NULL_DBM;
						// init the sender address parts
						memset( &m_tunneledWirelessAddressParts[0], 0, sizeof(m_tunneledWirelessAddressParts) );
						break;
				...
				{
					m_Packet.fMediaSpecInfoBlock = NULL;
				}
				break;
			case Attrib_ChannelNumber:
				...
				switch ( m_mediaInfo.StdHeader.nType )
				{
					...
					case kMediaSpecificHdrType_FullDuplex:
						...
						break;
					case kMediaSpecificHdrType_TunneledWireless:
						m_mediaInfo.MediaInfo.tunneledWireless.Wireless.Channel.Channel = (SInt16) theAttrib.fieldValue;
						break;
					default:	// WTF?
						ASSERT(0);
						break;
			...
			case Attrib_ChannelFreq:
				if ( m_mediaInfo.StdHeader.nType == kMediaSpecificHdrType_Wireless3 )
				{
					m_mediaInfo.MediaInfo.wireless.Channel.Frequency = (UInt32) theAttrib.fieldValue;
				}
				else if ( m_mediaInfo.StdHeader.nType == kMediaSpecificHdrType_TunneledWireless )
				{
					m_mediaInfo.MediaInfo.tunneledWireless.Wireless.Channel.Frequency = (UInt32) theAttrib.fieldValue;
				}
				break;
			case Attrib_ChannelBand:
				...
				{
					m_mediaInfo.MediaInfo.tunneledWireless.Wireless.Channel.Band = (UInt32) theAttrib.fieldValue;
				}
				break;
			case Attrib_DataRate:
				...
				{
					m_mediaInfo.MediaInfo.tunneledWireless.Wireless.DataRate = (UInt16) theAttrib.fieldValue;
				}
				break;
			case Attrib_SignalStrength:
				...
				{
					m_mediaInfo.MediaInfo.tunneledWireless.Wireless.SignalPercent = (UInt8) theAttrib.fieldValue;
				}
				break;
			case Attrib_SignaldBm:
				...
				{
					m_mediaInfo.MediaInfo.tunneledWireless.Wireless.SignaldBm = 
						WirelessHeaderUtil::dBmConvert( (SInt16) theAttrib.fieldValue );
				}
				break;
			case Attrib_SignaldBm1:
				...
				{
					m_mediaInfo.MediaInfo.tunneledWireless.Wireless.SignaldBm1 = (SInt8) theAttrib.fieldValue;
				}
				break;
			case Attrib_SignaldBm2:
				...
				{
					m_mediaInfo.MediaInfo.tunneledWireless.Wireless.SignaldBm2 = (SInt8) theAttrib.fieldValue;
				}
				break;
			case Attrib_SignaldBm3:
				...
				{
					m_mediaInfo.MediaInfo.tunneledWireless.Wireless.SignaldBm3 = (SInt8) theAttrib.fieldValue;
				}
				break;
			case Attrib_NoiseStrength:
				...
				{
					m_mediaInfo.MediaInfo.tunneledWireless.Wireless.NoisePercent = (UInt8) theAttrib.fieldValue;
				}
				break;
			case Attrib_NoisedBm:
				...
				{
					m_mediaInfo.MediaInfo.tunneledWireless.Wireless.NoisedBm = 
						WirelessHeaderUtil::dBmConvert( (SInt16) theAttrib.fieldValue );
				}
				break;
			case Attrib_NoisedBm1:
				...
				{
					m_mediaInfo.MediaInfo.tunneledWireless.Wireless.NoisedBm1 = (SInt8) theAttrib.fieldValue;
				}
				break;
			case Attrib_NoisedBm2:
				...
				{
					m_mediaInfo.MediaInfo.tunneledWireless.Wireless.NoisedBm2 = (SInt8) theAttrib.fieldValue;
				}
				break;
			case Attrib_NoisedBm3:
				...
				{
					m_mediaInfo.MediaInfo.tunneledWireless.Wireless.NoisedBm3 = (SInt8) theAttrib.fieldValue;
				}
				break;
			case Attrib_FlagsN:
				if ( m_mediaInfo.StdHeader.nType == kMediaSpecificHdrType_Wireless3 )
				...
				{
					m_mediaInfo.MediaInfo.tunneledWireless.Wireless.FlagsN = theAttrib.fieldValue;
				}
				break;
			case Attrib_SignaldBm4:
				if ( m_mediaInfo.StdHeader.nType == kMediaSpecificHdrType_TunneledWireless )
				{
					m_mediaInfo.MediaInfo.tunneledWireless.SignaldBm4 = (SInt8) theAttrib.fieldValue;
				}
				break;
			case Attrib_NoisedBm4:
				if ( m_mediaInfo.StdHeader.nType == kMediaSpecificHdrType_TunneledWireless )
				{
					m_mediaInfo.MediaInfo.tunneledWireless.NoisedBm4 = (SInt8) theAttrib.fieldValue;
				}
				break;
			case Attrib_AccessPointAddress1:
				if ( m_mediaInfo.StdHeader.nType == kMediaSpecificHdrType_TunneledWireless )
				{
					m_tunneledWirelessAddressParts[0] = theAttrib.fieldValue;
				}
				break;
			case Attrib_AccessPointAddress2:
				if ( m_mediaInfo.StdHeader.nType == kMediaSpecificHdrType_TunneledWireless )
				{
					m_tunneledWirelessAddressParts[1] = theAttrib.fieldValue;
				}
				break;
			case Attrib_AccessPointAddress3:
				if ( m_mediaInfo.StdHeader.nType == kMediaSpecificHdrType_TunneledWireless )
				{
					m_tunneledWirelessAddressParts[2] = theAttrib.fieldValue;
				}
				break;
			case Attrib_AccessPointAddress4:
				if ( m_mediaInfo.StdHeader.nType == kMediaSpecificHdrType_TunneledWireless )
				{
					m_tunneledWirelessAddressParts[3] = theAttrib.fieldValue;
				}
				break;
			case Attrib_RemoteAPCollectorPort:
				if ( m_mediaInfo.StdHeader.nType == kMediaSpecificHdrType_TunneledWireless )
				{
					m_mediaInfo.MediaInfo.tunneledWireless.ReceiverPort = (UInt16) theAttrib.fieldValue;
				}
				break;
			...
			case Attrib_PacketDataLength:	
				...
				// this should be the last attribute before packet data
				if ( m_mediaInfo.StdHeader.nType == kMediaSpecificHdrType_TunneledWireless )
				{
					if ( (m_tunneledWirelessAddressParts[1] > 0) || (m_tunneledWirelessAddressParts[2] > 0) || (m_tunneledWirelessAddressParts[3] > 0) )
					{
						// ipv6 address
						m_mediaInfo.MediaInfo.tunneledWireless.SenderAddress.Type = PEEK_IP_ADDRESS_TYPE_V6;
						for ( size_t i = 0, ipv6Offset = 0; i < 4; ++i, ipv6Offset +=4 )
						{
							const UInt32	addressFragment = m_tunneledWirelessAddressParts[i];
							m_mediaInfo.MediaInfo.tunneledWireless.SenderAddress.ipv6[ipv6Offset]     = static_cast<UInt8>((addressFragment >> 24) & 0xff);
							m_mediaInfo.MediaInfo.tunneledWireless.SenderAddress.ipv6[ipv6Offset + 1] = static_cast<UInt8>((addressFragment >> 16) & 0x0ff);
							m_mediaInfo.MediaInfo.tunneledWireless.SenderAddress.ipv6[ipv6Offset + 2] = static_cast<UInt8>((addressFragment >> 8) & 0xff);
							m_mediaInfo.MediaInfo.tunneledWireless.SenderAddress.ipv6[ipv6Offset + 3] = static_cast<UInt8>(addressFragment & 0xff);
						}
					}
					else if ( m_tunneledWirelessAddressParts[0] > 0 )
					{
						// ipv4 address
						m_mediaInfo.MediaInfo.tunneledWireless.SenderAddress.Type = PEEK_IP_ADDRESS_TYPE_V4;
						m_mediaInfo.MediaInfo.tunneledWireless.SenderAddress.ipv4 = m_tunneledWirelessAddressParts[0];
					}
				}
