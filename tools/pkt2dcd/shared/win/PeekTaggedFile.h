...
protected:
	...
	struct STunneledWirelessHeader
	{
		TaggedFile::PacketAttribute	channelNumber;
		TaggedFile::PacketAttribute	channelFreq;
		TaggedFile::PacketAttribute	channelBand;
		TaggedFile::PacketAttribute	dataRate;
		TaggedFile::PacketAttribute	signalStrength;
		TaggedFile::PacketAttribute	signaldBm;
		TaggedFile::PacketAttribute	signaldBm1;
		TaggedFile::PacketAttribute	signaldBm2;
		TaggedFile::PacketAttribute	signaldBm3;
		TaggedFile::PacketAttribute	noiseStrength;
		TaggedFile::PacketAttribute	noisedBm;
		TaggedFile::PacketAttribute	noisedBm1;
		TaggedFile::PacketAttribute	noisedBm2;
		TaggedFile::PacketAttribute	noisedBm3;
		TaggedFile::PacketAttribute	flagsN;
		TaggedFile::PacketAttribute	signaldBm4;
		TaggedFile::PacketAttribute	noisedBm4;
		TaggedFile::PacketAttribute	accessPointAddress1;
		TaggedFile::PacketAttribute	accessPointAddress2;
		TaggedFile::PacketAttribute	accessPointAddress3;
		TaggedFile::PacketAttribute	accessPointAddress4;
		TaggedFile::PacketAttribute	collectorPort;
	};
	...
	STunneledWirelessHeader		m_tunneledWirelessHeader;
	UInt32						m_tunneledWirelessAddressParts[4];
