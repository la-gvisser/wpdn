...
public:
	...
	TString			Mid( Y iFirst, Y nCount ) const;
	bool			Replace( TCHAR cOld, TCHAR cNew );

	bool SetLength( Y inCharsNeeded ) { return AdjustCapacity( inCharsNeeded ); }
