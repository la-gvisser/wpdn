...
//	tagfile.h
// =============================================================================
//	Copyright (c) 2003-2014 WildPackets, Inc. All rights reserved.
...
// XML attributes that are used in the version and session blocks.
...
#define kCaptureFileSessionBlock_Adapters			_T("Adapters")
#define kCaptureFileSessionBlock_Adapter			_T("Adapter")
