...
//	MemUtil.h
// =============================================================================
//	Copyright (c) 2000-2005 WildPackets, Inc. All rights reserved.
...
// NetworkToHost()
//
// 6 overloads of NetworkToHost() to cover all permutations of
// {signed, unsigned}{8,16,32 bits}
//
// Makes it possible to call byteswapping functions from a template.
