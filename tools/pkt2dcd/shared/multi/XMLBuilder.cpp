...
// Static members.
SInt32 XXMLBuilder::s_nDepth;	// Current element depth.
...
#ifdef _WIN32
	return m_Stream->Write( CW2AEX_WP<>( inString ) );
#else
	return false;
#endif
}
	...
	const XString&	inString )
{
	...
	char* utf8 = new char[ wcslen(inString) + 1 ];
	if ( utf8 == nullptr )
	{
		return false;
	}
	int ret = wcstombs( utf8, inString, sizeof(utf8) );
	if ( (ret == sizeof(utf8)) && (sizeof(utf8) > 0) )
	{
