...
#ifndef IS_ETHERNET
#define IS_ETHERNET(inMediaType, inMediaSubtype)	(inMediaType == kMediaType_802_3 && inMediaSubtype == kMediaSubType_Native)
#endif /*IS_ETHERNET*/

#ifndef IS_TOKENRING
#define IS_TOKENRING(inMediaType, inMediaSubtype)	(inMediaType == kMediaType_802_5 && inMediaSubtype == kMediaSubType_Native)
#endif /*IS_TOKENRING*/
...
#ifndef IS_WAN
#define IS_WAN(inType, inSubType)	 (inType == kMediaType_CoWan || inType == kMediaType_Wan)
#endif /*IS_WAN*/
...
enum TMediaSpecType {
	...
	kMediaSpecType_ProtoSpecHierarchy	= 7,		///< ProtoSpec ID Hierarchy
	kMediaSpecType_ApplicationID		= 8,		///< Application ID
...
/// \brief Media spec sizes for each media spec type.
#ifndef kMediaSpecSize
#define kMediaSpecSize
#define kMediaSpecSize_EthernetProto		2
#define kMediaSpecSize_LSAP					1
#define kMediaSpecSize_SNAP					5
#define kMediaSpecSize_LAP					1
#define kMediaSpecSize_DDP					1
#define kMediaSpecSize_MACCtl				1
#define kMediaSpecSize_ProtoSpecHierarchy	64
#define kMediaSpecSize_ApplicationID		8
#define kMediaSpecSize_ProtoSpec			4
#define kMediaSpecSize_EthernetAddr			6
#define kMediaSpecSize_TokenRingAddr		6
#define kMediaSpecSize_LAPAddr				6
#define kMediaSpecSize_WirelessAddr			6
#define kMediaSpecSize_AppleTalkAddr		3
#define kMediaSpecSize_IPAddr				4
#define kMediaSpecSize_DECnetAddr			2
#define kMediaSpecSize_OtherAddr			0
#define kMediaSpecSize_IPv6Addr				16
#define kMediaSpecSize_IPXAddr				10
#define kMediaSpecSize_Error				1
#define kMediaSpecSize_ATPort				1
#define kMediaSpecSize_IPPort				2
#define kMediaSpecSize_NWPort				2
#define kMediaSpecSize_TCPPortPair			4
#define kMediaSpecSize_WAN_PPP_Proto		2
#define kMediaSpecSize_WAN_FrameRelay_Proto	2
#define kMediaSpecSize_WAN_X25_Proto		0
#define kMediaSpecSize_WAN_X25e_Proto		0
#define kMediaSpecSize_WAN_Ipars_Proto		0
#define kMediaSpecSize_WAN_U200_Proto		0
#define kMediaSpecSize_WAN_DLCIAddr			2
#define kMediaSpecSize_WAN_Q931_Proto		0
#endif
...
struct tMediaType {
	TMediaType		fType;
	TMediaSubType	fSubType;

	tMediaType( TMediaType inType = kMediaType_802_3, TMediaSubType inSubType = kMediaSubType_Native ) {
		fType = inType;
		fSubType = inSubType;
	}
	bool operator==( const tMediaType& inOther ) {
		return fType == (inOther.fType) && (fSubType == inOther.fSubType);
		}
	bool operator!=( const tMediaType& inOther ) {
		return fType != (inOther.fType) || (fSubType == inOther.fSubType);
		}
	bool	IsEthernet() const { return IS_ETHERNET( fType, fSubType ); }
	bool	IsWAN() const { return IS_WAN( fType, fSubType ); }
	bool	IsWireless() const { return IS_WIRELESS( fSubType ); }
} WP_PACK_STRUCT;
