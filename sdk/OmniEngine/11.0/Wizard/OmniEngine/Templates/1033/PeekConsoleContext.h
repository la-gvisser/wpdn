...
public:
	;	CPeekConsoleContext( const CGlobalId& inId, CRemotePlugin* inRemotePlugin )
...
#ifdef IMPLEMENT_PLUGINMESSAGE
	bool				PostPluginMessage( CPeekMessagePtr inMessage, CPeekMessageProcess* inMsgProc,
		FnResponseProcessor inResponseProc );
	virtual bool		SendPluginMessage( CPeekStream& inMessage, DWORD inTimeout, DWORD& outTransId );
#endif // IMPLEMENT_PLUGINMESSAGE
