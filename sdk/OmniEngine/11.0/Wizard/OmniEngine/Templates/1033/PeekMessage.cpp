...
{
	_ASSERTE( inMsgProc != nullptr );
	if ( inMsgProc == nullptr ) return false;
	_ASSERTE( inResponseProc != nullptr );
	if ( inResponseProc == nullptr ) return false;
