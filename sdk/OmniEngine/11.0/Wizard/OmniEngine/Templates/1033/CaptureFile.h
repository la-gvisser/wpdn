...
typedef struct _tFileMode {
	...
	_tFileMode( int inType, int inAccess, bool inScan = false, 
			tMediaType inMediaType = MT_ETHERNET )
		: fType( inType )
		, fScan( inScan )
		, fAccess( inAccess )
...
public:
	...
	void	SetMediaType( const tMediaType& inMediaType ) { m_MediaType = inMediaType; }
