...
//	omnigraphs.h
// =============================================================================
//	Copyright (c) 2004-2008 WildPackets, Inc. All rights reserved.
...
#define IGraphData_IID \
{ 0x87D90C5A, 0x9E22, 0x401b, {0xB0, 0x36, 0xD1, 0x57, 0x60, 0x9F, 0x3B, 0x30} }

class HE_NO_VTABLE IGraphData : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IGraphData_IID);

	HE_IMETHOD GetStartTime( /*out*/ UInt64* pVal ) = 0;
	HE_IMETHOD GetEndTime( /*out*/ UInt64* pVal ) = 0;
	HE_IMETHOD GetLength(/*out*/ UInt32* pVal) = 0;
	HE_IMETHOD SetLength(/*in*/ UInt32 newVal) = 0;
	HE_IMETHOD GetData( /*in*/ UInt32 Count,/*out*/ float pVal[] ) = 0;
};
...
public:
	...
	HE_IMETHOD GetData(/*in*/ UInt64 StartTime, /*in*/ UInt32* NumSamples, 
		/*in*/ UInt32 SamplesToDrop, /*out*/ double GraphData[], /*out*/ UInt64 TSData[]) = 0;
...
public:
	...
	HE_IMETHOD Init(/*in*/ PeekSummaryStatType StatType, 
				 /*in*/ const Helium::HeID& StatItemId,
