...
enum SizeStatsBucketSetID
{
	...
	kSizeStatsBucketSetID_Ethernet,		///<  0-64, 65-127, 128-255, 256-511, 512-1023, 1024-1517, 1518+
	kSizeStatsBucketSetID_TokenRing,	///< 18-63, 64-127, 128-255, 256-511, 512-1023, 1024-2047, 2048-4095, 4096-8191, 8192-17999, 18000+
	kSizeStatsBucketSetID_Wireless,		///<  0-63, 64-127, 128-255, 256-511, 512-1023, 1024-2047, 2048+
	kSizeStatsBucketSetID_GigEthernet,	///<  0-64, 65-127, 128-255, 256-511, 512-1023, 1024-1518, 1519-2047, 2048-4095, 4096-8191, 8192-9017, 9018-9022, 9023+
	kSizeStatsBucketSetID_WAN			///<  0-64, 65-127, 128-255, 256-511, 512-1023, 1024-1518, 1518+
};

/// \internal
/// \interface ISizeStats
/// \brief Packet size statistics.
/// Ranges for Ethernet (7):<br>
/// <= 64, 65-127, 128-255, 256-511, 512-1023, 1024-1517, >= 1518<br>
/// Ranges for TokenRing (10):<br>
/// 18-63, 64-127, 128-255, 256-511, 512-1023, 1024-2047, 2048-4095, 4096-8191, 8192-17999, >= 18000<br>
/// Ranges for Wireless (7):<br>
/// < 64, 64-127, 128-255, 256-511, 512-1023, 1024-2047, 2048-2346
/// \see SizeStats
...
/// \internal
/// \struct PeekSummaryStatEntry
/// \brief Summary stat with ID.
/// \see ISummaryStatsSnapshot
#include "hepushpack.h"
struct PeekSummaryStatEntry
{
	Helium::HeID		ID;				///< The stat ID.
	PeekSummaryStat		Stat;			///< The stat value.
} HE_PACK_STRUCT;
#include "hepoppack.h"
...
/// \defgroup StatsSnapshot Summary statistics interfaces and classes implemented by Omni.
/// \brief Summary statistics-related interfaces and classes.
///
/// These interfaces and classes are implemented by Omni to allow items to be added
/// to the display of summary statistics.

/// \interface ISummaryStatsSnapshot
/// \ingroup StatsSnapshot
...
public:
	...
	HE_IMETHOD CreateTable(/*in*/ enum ExpertTableID tableID,
						   /*in*/ enum ColumnSet columnSet, /*out*/ IExpertTable** ppVal) = 0;
};
