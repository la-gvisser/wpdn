...
public:
	...
	HE_IMETHOD CreateHarwareFilters(/*in*/ void* pFilterData, /*in*/ UInt32 nDataLength) = 0;
...
public:
	...
	HE_IMETHOD SetReplayLimit(/*in*/ UInt32 ulReplayLimit) = 0;
...
struct PacketLayerInfo
{
	...
	UInt8*		pHeader;		///< Pointer to the start of the layer's header.
	UInt8*		pPayload;		///< Pointer to the start of the layer's payload.
} HE_PACK_STRUCT;
#include "hepoppack.h"
...
///
/// Optional interface implemented by Distributed Analysis Modules and used by the OmniPeek console.
/// This interface is exposed by a Distributed Analysis Module that needs to display information in the
/// Summary column of the OmniPeek console's packet list.
