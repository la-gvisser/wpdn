...
class HE_NO_VTABLE IFilter : public Helium::IHeUnknown
{
public:
...
public:
	...
	HE_IMETHOD GetItem(/*in*/ SInt32 lIndex, /*out*/ IFilter** ppFilter) = 0;
	/// Get the count of filters in the list.
	HE_IMETHOD GetCount(/*out*/ SInt32* plCount) = 0;
	/// Get a filter by id.
	HE_IMETHOD ItemFromID(/*in*/ const Helium::HeID& id, /*out*/ IFilter** ppFilter) = 0;
	/// Add a filter.
	HE_IMETHOD Add(/*in*/ IFilter* pFilter) = 0;
	/// Remove a filter.
	HE_IMETHOD Remove(/*in*/ IFilter* pFilter) = 0;
	/// Remove all filters.
