...
protected:
	...
	bool			DoLoadPlugin();
	void			DoUnloadPlugin( bool inMustHavePlugin );
...
//		HE_INTERFACE_ENTRY_IID(IPluginUISource_IID,IPluginUISource)		// NO UI
...
public:
	...
	// IPluginAdapter
public:
	HE_IMETHOD		DeleteAdapter( const Helium::HeID& inAdapterId );
