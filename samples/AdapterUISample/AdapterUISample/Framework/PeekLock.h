...
#define PeekAtomicIncrement32(p)			HeAtomicIncrement32(p)
#define PeekAtomicDecrement32(p)			HeAtomicDecrement32(p)
#define PeekAtomicExchange32(p)				HeAtomicExchange32(p)
#define PeekAtomicCompareExchange32(p,v,c)	HeAtomicCompareExchange32(p,v,c)
#define PeekAtomicExchangePointer(pp,v)		HeAtomicExchangePointer(pp,v)
