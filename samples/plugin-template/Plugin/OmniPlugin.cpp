...
GUID			g_PluginId = { 0x77AD834A, 0x5470, 0x451C, { 0xBF, 0xE4, 0x74, 0xDE, 0x02, 0xB9, 0x84, 0x55 } };
CPeekString		COmniPlugin::s_strName( L"PluginTemplateOE" );
#ifdef _WIN32
	...
	CRemotePlugin*	inRemotePlugin )
{
	...
	//   %ALLUSERSPROFILE\Application Data\Savvius\Plugins\PluginTemplate-About.zip
	//   %ALLUSERSPROFILE\Application Data\Savvius\Plugins\PluginTemplate-Options.zip
	//   %ALLUSERSPROFILE\Application Data\Savvius\Plugins\PluginTemplate-Tab.zip
