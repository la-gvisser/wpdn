...
public:
	...
	void	Set( UInt32 inMostSignificant, UInt32 inLeastSignificant ) {
		m_nMajorVersion = (inMostSignificant & 0xFFFF0000) >> 16;
		m_nMinorVersion = inMostSignificant & 0x0000FFFF;
		m_nMajorRevision = (inLeastSignificant & 0xFFFF0000) >> 16;
		m_nMinorRevision = inLeastSignificant & 0x0000FFFF;
	}
...
#endif
#ifdef _WIN32
bool		GetModuleVersion( CVersion& outFile, CVersion& outProduct, HMODULE inModule = nullptr );
#endif
bool		GetFileVersion( const wchar_t* inFilePath, CVersion& outFile, CVersion& outProduct );
}	// namespace Environment
