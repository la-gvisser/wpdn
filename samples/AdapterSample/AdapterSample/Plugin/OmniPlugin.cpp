...
GUID			g_PluginId = { 0xA2502F1A, 0x6912, 0x4EEC, { 0xA2, 0x67, 0xE9, 0x63, 0x9B, 0x3A, 0x68, 0x66 } };
CGlobalId		COmniPlugin::s_idClass( g_PluginId );
CPeekString		COmniPlugin::s_strName( L"AdapterSample" );
...
#endif // IMPLEMENT_PLUGINMESSAGE
{
	...
	strEnvProgramData.GetEnvironmentVariable( L"PROGRAMDATA" );

	CPeekOutString	strPrefsFilePath;
	strPrefsFilePath << strEnvProgramData << L"\\WildPackets\\Plugins";
	CFileEx::MakePath( strPrefsFilePath );

	strPrefsFilePath << L"\\AdapterSample.xml";
