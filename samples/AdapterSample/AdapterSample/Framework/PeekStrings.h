// ============================================================================
//	PeekStrings.h
//		interface for: CPeekString, CPeekStringA, CStringX.
// ============================================================================
...
public:
	;			CStringX() {}
	;			CStringX( const CPeekStringA& inStrA )
		: m_strW( inStrA ), m_strA( inStrA ) {}
	;			CStringX( const CPeekString& inStrW )
	...
	CStringX	operator=( const CPeekStringA& inStrA ) {
		m_strW = CPeekString( m_strA = inStrA );
		return *this;
	}
	CStringX	operator=( const CPeekString& inStrW ) {
		m_strA = CPeekStringA( m_strW = inStrW );
		return *this;
	}

	bool		operator==( const CStringX& inStrX ) const {
