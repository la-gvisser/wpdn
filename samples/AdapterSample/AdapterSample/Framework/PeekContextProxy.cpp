...
CPacketBuffer::operator=(
	const CPersistFile& inPersistFile )
{
	CHePtr<Helium::IHePersistFile>	spPersistFile = inPersistFile.GetPtr();
	CHePtr<IPacketBuffer>			spPacketBuffer;
	Peek::ThrowIfFailed( spPersistFile.QueryInterface( &spPacketBuffer.p ) );
