...
public:
	...
	bool		IsNotValid() const { return (m_spColumn == NULL); }
	bool		IsValid() const { return (m_spColumn != NULL); }
...
public:
	...
	bool		IsNotValid() const { return (m_spCols == NULL); }
	bool		IsValid() const { return (m_spCols != NULL); }
	...
	bool Add( CPeekString inColumnName, UInt16 inDataType ) {
		...
		Peek::ThrowIfFailed( m_spCols->Add( sColumnName, inDataType, NULL ) );
...
public:
	...
	bool		IsNotValid() const { return (m_spRow == NULL); }
	bool		IsValid() const { return (m_spRow != NULL); }
...
public:
	...
	bool		IsNotValid() const { return (m_spRows == NULL); }
	bool		IsValid() const { return (m_spRows != NULL); }
...
public:
	...
	bool		IsNotValid() const { return (m_spDataTable == NULL); }
	bool		IsValid() const { return (m_spDataTable != NULL); }
