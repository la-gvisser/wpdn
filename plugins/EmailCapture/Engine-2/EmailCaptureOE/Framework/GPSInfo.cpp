...
//	GPSInfo.cpp
// =============================================================================
//	Copyright (c) 2004-2015 Savvius, Inc. All rights reserved.
...
// const UInt32	TEXT_BUFFSIZE = 1024;
	...
	SInt32& outAltitude ) const
{
	...
	outAltitude = static_cast<SInt32>( m_GpsInfo.fAltitude );
	return true;
}
	...
	bool	/*inLocalTime*/ ) const
{
	...
	if ( (m_GpsInfo.fFlags & kWpGps_Valid_GPSTime) && !bCautioned ) {
		...
		CPeekTime	ptTime( m_GpsInfo.fGpsTime );
		strFormat = L"Date " + ptTime.FormatDate() +
			L" Time " + ptTime.FormatTime();
	}
	else {
		strFormat = L"N/A";
	}
