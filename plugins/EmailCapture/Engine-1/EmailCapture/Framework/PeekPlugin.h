...
public:
	...
	int				GetInstalledOnEngine() const { return kOnEngine_True /*m_nOnEngine*/; }
	...
	bool			IsInstalledOnEngine() const { return true /*(m_nOnEngine == kOnEngine_True)*/; }
