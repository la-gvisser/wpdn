...
public:
	;		CPeekXmlLoad( PCWSTR inRootName ) { Create( inRootName ); }
...
public:
	;		CPeekXmlStore( PCWSTR inRootName ) { Create( inRootName ); }
...
public:
	;		CPeekDataModeler( PCWSTR inRootName )
	{
		CPeekXmlTransferPtr	sp( new CPeekXmlStore( inRootName ) );
		m_spXml = sp;
	}
	;		CPeekDataModeler( PCWSTR inFileName, PCWSTR inRootName )
 	{
		CPeekXmlTransferPtr	sp( new CPeekXmlLoad( inFileName, inRootName ) );
		m_spXml = sp;
	}
