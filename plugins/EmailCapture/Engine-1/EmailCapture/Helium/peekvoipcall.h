...
//	peekvoipcall.h
// =============================================================================
//	Copyright (c) 2007-2010 WildPackets, Inc. All rights reserved.
...
public:
	...
	HE_IMETHOD GetMediaKey(/*in*/ UInt32 index, /*out*/ Helium::HEBSTR* pbstrKey) = 0;
...
{ 0x527EA421, 0xAE8B, 0x4742, {0xB0, 0xAE, 0x90, 0x3B, 0xAE, 0x50, 0xB9, 0xC4} }
...
/// \interface IProcessPacketWithFlowID
/// \brief For the processing of VoIP packets.
#define IProcessPacketWithFlowID_IID \
{ 0xB5E5F7B5, 0x72E3, 0x4eae, {0x8A, 0x42, 0x48, 0x98, 0x72, 0xDE, 0x7C, 0x72} }

class HE_NO_VTABLE IProcessPacketWithFlowID : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IProcessPacketWithFlowID_IID);

	/// If pPacket does indeed belong to this call, and we're able to add it 
	/// to our stats, return HE_S_OK. If the packet does not belong to our flow, return HE_S_FALSE.
	HE_IMETHOD ProcessPacketWithFlowID(/*in*/ IPacket* pPacket, /*in*/ UInt32 nFlowID) = 0;
};
