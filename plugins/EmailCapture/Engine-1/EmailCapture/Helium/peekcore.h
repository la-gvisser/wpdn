...
//	peekcore.h
// =============================================================================
//	Copyright (c) 2001-2010 WildPackets, Inc. All rights reserved.
...
/// \see coclass XyratexUtil, coclass DagUtil, coclass NapatechUtil
#define IGigUtil_IID \
...
public:
	...
	HE_IMETHOD Close() = 0;
	/// Get a packet.
	HE_IMETHOD GetNextPacket(/*out*/ UInt8** pData, /*out*/ PeekPacket& peekPacket) = 0;
...
public:
	...
	HE_IMETHOD GetAdapterCount(SInt32* pnAdapters) = 0;
...
/// \see coclass XyratexHardwareFilter, NapatechHardwareFilter
...
enum PeekFilterMode
{
	...
	peekFilterModeAcceptMatching,	///< Accept only packets matching filters.
	peekFilterModeRejectAll,		///< Reject all packets.
	peekFilterModeRejectMatching	///< Reject packets matching filters.
};
...
public:
	...
	/// \param pusBytesToAccept Pointer to a variable that receives the sliced length
	/// of the packet.
...
public:
	...
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	/// \remarks None
	HE_IMETHOD GetPacketDataEnd(/*out*/ const UInt8** ppPacketData) = 0;
	/// \internal
	...
	/// \param pusPacketLength Pointer to a variable that receives the packet length.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	...
	/// \param pusSliceLength Pointer to a variable that receives the slice length.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	...
	/// \param pusActualLength Pointer to a variable that receives the actual length.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	...
	/// \param pulFlags Pointer to a variable that receives the flags bits.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	/// \remarks None
	...
	/// \param pulStatus Pointer to a variable that receives the status bits.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	/// \remarks None
	...
	/// \param pullTimeStamp Pointer to a variable that receives the timestamp.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	...
	/// \param pulProtoSpec Pointer to a variable that receives the ProtoSpec instance ID.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	/// \remarks None
	...
	/// \param pusProtoSpecID Pointer to a variable that receives the ProtoSpec ID.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	/// \remarks None
	...
	/// \param pbDuplexPacket Pointer to a boolean that is true if the packet is a full duplex packet.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	/// \remarks None
	...
	/// \param pusBytesRemaining Pointer to a variable that receives the number of bytes remaining in the packet.
	/// This parameter may be NULL if this information is not needed.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER One of the pointers is invalid.
	...
	/// \param pChannel Pointer to a variable that receives the full duplex channel number.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	...
	/// \param pFlagsN Pointer to a variable that receives the flags.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	/// \remarks None
	...
	/// \param nLevel 802.11N channel stream
	/// \param pSignaldBm Pointer to a variable that receives the signal level in dBm.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
...
public:
	...
	HE_IMETHOD GetPacket(/*in*/ IPacket* pIPacket, /*in*/ UInt32 nIndex) = 0;
...
public:
	...
	HE_IMETHOD PutPacket(/*in*/ IPacket* pIPacket, /*in*/ UInt16 cbDataSize) = 0;
};
...
public:
	...
	HE_IMETHOD SetLimit(/*in*/ LimitMode mode, /*in*/ UInt32 nLimitCount) = 0;
	/// Load - blocking call.
	/// pFiles is a DataTable.
	HE_IMETHOD Load(/*in*/ Helium::IHeUnknown* pFiles) = 0;
	/// Stop loading.
	HE_IMETHOD Stop() = 0;
...
public:
	...
	/// Handle a packet.
	HE_IMETHOD HandlePacket(/*in*/ IPacket* pIPacket) = 0;
};

/// \internal
/// \interface IPacketProvider
/// \ingroup PacketHandler
/// \brief Provides packets to IPacketHandlers
/// \see coclass IPacketHandler
...
public:
	...
	HE_IMETHOD AddPacketHandler(/*in*/ IPacketHandler* pIPacketHandler) = 0;
	/// Remove a packet handler.
	HE_IMETHOD RemovePacketHandler(/*in*/ IPacketHandler* pIPacketHandler) = 0;
};
...
public:
	...
	/// \param pIPacket Pointer to an IPacket interface that allows the
	/// Distributed Analysis Module to get information about the packet.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	...
	HE_IMETHOD ProcessPacket(/*in*/ IPacket* pIPacket) = 0;
};
...
public:
	...
	HE_IMETHOD ProcessTime(UInt64 nCurrentTime) = 0;
};
...
/// \see IProcessPacket, IPacketBuffer, IPacket
...
public:
	...
	HE_IMETHOD GetItem(/*in*/ SInt32 lIndex, /*out*/ Helium::IHeUnknown** ppUnk) = 0;
...
///
/// This interface is implemented by the OmniPeek console and OmniEngine and provides access to ProtoSpecs.
...
public:
	...
	/// \param ulDataBytes The number of bytes in the packet.
...
public:
	...
	/// \retval HE_E_INVALID_POINTER The pointer is invalid
	/// \remarks None
	HE_IMETHOD IsMediaSupported(/*in*/ TMediaType mt, /*in*/ TMediaSubType mst, /*out*/ BOOL* pbResult) = 0;
};
...
public:
	...
	HE_IMETHOD Add(/*in*/ IHeUnknown* pConfig) = 0;
	/// Get the count of plugin IDs.
	HE_IMETHOD GetCount(/*out*/ SInt32* pnCount) = 0;
	/// Get a config (Xml Document) by Class ID.
	HE_IMETHOD GetItem(/*in*/ const Helium::HeCID& cid, /*out*/ IHeUnknown** ppConfig) = 0;
	/// Get a config (Xml Document) by index.
	HE_IMETHOD GetItem(/*in*/ SInt32 nIndex, /*out*/ IHeUnknown** ppConfig) = 0;
	/// Remove a config.
...
public:
	...
	HE_IMETHOD IsCapturing(/*out*/ BOOL* pbCapturing) = 0;
	/// Start capture.
	HE_IMETHOD StartCapture(/*in*/ BOOL bFullReset ) = 0;
	/// Stop capture.
	HE_IMETHOD StopCapture() = 0;
...
public:
	...
	HE_IMETHOD GetItem(/*in*/ SInt32 lIndex, /*out*/ IPeekCapture** ppIPeekCapture) = 0;
	/// Get the count of peek captures in the list.
	HE_IMETHOD GetCount(/*out*/ SInt32* pnCount) = 0;
	/// Get a peek capture by ID.
	HE_IMETHOD ItemFromID(/*in*/ const Helium::HeID& guidID, /*out*/ IPeekCapture** ppIPeekCapture) = 0;
};
...
public:
	...
	// Get the PropertyBag
	HE_IMETHOD GetPropertyBag(/*out*/ Helium::IHePropertyBag** pVal) = 0;
	// Put a PropertyBag
	HE_IMETHOD SetPropertyBag(/*in*/ Helium::IHePropertyBag* newVal) = 0;
	// Get the id.
...
/// \internal
/// \interface IOmniStoragePacketBuffer
/// \ingroup PacketBuffer
/// \brief Packet buffer that uses advanced storage.
/// \see coclass OmniStoragePacketBuffer
#define IOmniStoragePacketBuffer_IID \
{ 0x2ACE6F78, 0xDCDC, 0x4298, {0xA2, 0xF2, 0xF4, 0x87, 0xED, 0x2C, 0x3F, 0xA8} }

class HE_NO_VTABLE IOmniStoragePacketBuffer : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IOmniStoragePacketBuffer_IID);

	HE_IMETHOD GetProcessedPacketCount( /*out*/ UInt32 * pulPacketCount ) = 0;
	HE_IMETHOD SetCaptureSessionID(/*in*/ SInt32 nCaptureSessionID) = 0;
	HE_IMETHOD SetTimeFilter(/*in*/ UInt64 nStartTime, /*in*/ UInt64 nEndTime) = 0;
	HE_IMETHOD SetFilterMode(/*in*/ PeekFilterMode fm) = 0;
	HE_IMETHOD SetPacketFilter(/*in*/ IFilterPacket* pPacketFilter) = 0;
	HE_IMETHOD Load( BOOL bPacketsOnlyLoad ) = 0;
	HE_IMETHOD Stop() = 0;
};

/// \internal
/// \interface IRemotePacketFeed
/// \ingroup Capture
/// \brief Remote adapter and capture management.
/// \see coclass RemoteAdapter
#define IRemotePacketFeed_IID \
{ 0xFDED6D7C, 0xA2C6, 0x4A36, {0xA1, 0x8C, 0x63, 0x17, 0xDC, 0xAE, 0x68, 0x10} }

class HE_NO_VTABLE IRemotePacketFeed : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IRemotePacketFeed_IID);

	/// Create a live packet feed from remote adapter.
	HE_IMETHOD CreatePacketFeed() = 0;
	/// Destroy a live packet feed from remote adapter.
	HE_IMETHOD DestroyPacketFeed() = 0;
};

/// \internal
/// \enum RemoteAdapterStatus
/// \ingroup Capture
/// \brief CaptureStatus: idle or capturing.
enum RemoteAdapterStatus
{
	remoteAdapterStatusIdle      = 0x0000,	///< Idle.
	remoteAdapterStatusCapturing = 0x0001	///< Capturing packets.
};

/// \internal
/// \enum RemoteCaptureFlags
/// \ingroup Capture
/// \brief CaptureFlags: CTD or Monitoring, continuous or one-time
enum RemoteCaptureFlags
{
	remoteCaptureToDisk     = 0x0001,		///< Capture to disk
	remoteCaptureToBuffer   = 0x0002,		///< Capture to memory buffer
	remoteCaptureContinuous = 0x0004		///< Capture continuously
};

/// \internal
/// \enum RemoteStopReason
/// \ingroup Capture
/// \brief AdapterStatus: idle or capturing.
enum RemoteStopReason
{
	remoteCaptureSuccess,				///< Capture finished successfully
	remoteCaptureDBError,				///< Capture stopped by DB error
	remoteCaptureCardError,				///< Capture stopped by card error
	remoteCaptureStorageFull,			///< Capture stopped by filling up storage
	remoteCaptureStorageLocked,			///< Capture stopped by reaching locked storage region
	remoteCaptureStorageError			///< Capture stopped by storage error
};

/// \internal
/// \interface IRemoteCaptureManager
/// \ingroup Capture
/// \brief Remote adapter and capture management.
#define IRemoteCaptureManager_IID \
{ 0x67EA0BE0, 0x1DFF, 0x4D34, {0x90, 0xA6, 0x5E, 0x9F, 0x25, 0x65, 0x46, 0x53} }

class HE_NO_VTABLE IRemoteCaptureManager : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IRemoteCaptureManager_IID);

	/// Execute remote capture process specified by exec path
	/// and have it listening on specified address.
	HE_IMETHOD StartRemoteProcess(/*in*/ Helium::HEBSTR bstrExecPath) = 0;
	/// Shutdown previously started remote capture process.
	HE_IMETHOD StopRemoteProcess() = 0;
	/// Connect to the remote process.
	HE_IMETHOD Connect(/*in*/ Helium::HEBSTR bstrAddress) = 0;
	/// Disconnect from the remote process.
	HE_IMETHOD Disconnect() = 0;
	/// Get the size and usage of the storage system.
	HE_IMETHOD GetStorageStatus(/*out*/ UInt64* pnTargets,
		/*out*/ UInt64* pnTotal,
		/*out*/ UInt64* pnUsed,
		/*out*/ UInt64* pnUnitSize) = 0;
	/// Get an array of adapter indices supported by remote capture process.
	HE_IMETHOD GetAdapterIDs(/*out*/ UInt32* pnCount,
		/*out*/ UInt32** payAdapterID ) = 0;
	/// Get adapter name string by its index.
	HE_IMETHOD GetAdapterName(/*in*/ UInt32 nAdapterIndex,
		/*out*/ Helium::HEBSTR* pbstrName) = 0;
	/// Get adapter version string by its index.
	HE_IMETHOD GetAdapterVersion(/*in*/ UInt32 nAdapterIndex,
		/*out*/ Helium::HEBSTR* pbstrVersion) = 0;
	/// Get adapter MAC address (1st port MAC).
	HE_IMETHOD GetAdapterMAC(/*in*/ UInt32 nAdapterIndex,
		/*out*/ UInt8* pAddress) = 0;
	/// Get adapter feature flags.
	HE_IMETHOD GetAdapterFeatures(/*in*/ UInt32 nAdapterIndex,
		/*out*/ UInt32* pnFeatures) = 0;
	/// Get adapter maximum link speed.
	HE_IMETHOD GetAdapterMaxLinkSpeed(/*in*/ UInt32 nAdapterIndex,
		/*out*/ UInt64* pnSpeed) = 0;
	/// Get adapter media type
	HE_IMETHOD GetAdapterMediaType(/*in*/ UInt32 nAdapterIndex,
		/*out*/ TMediaType* pMediaType ) = 0;
	/// Get adapter media sub type
	HE_IMETHOD GetAdapterMediaSubType(/*in*/ UInt32 nAdapterIndex,
		/*out*/ TMediaSubType* pMediaSubType ) = 0;
	/// Get adapter feature flags.
	HE_IMETHOD GetAdapterNumPorts(/*in*/ UInt32 nAdapterIndex,
		/*out*/ UInt32* pnNumPorts) = 0;
	/// Get adapter status.
	HE_IMETHOD GetAdapterStatus(/*in*/ UInt32 nAdapterIndex,
		/*out*/ RemoteAdapterStatus* pAdapterStatus ) = 0;
	/// Get number of dropped packets.
	HE_IMETHOD GetNumDroppedPackets(/*in*/ UInt32 nAdapterIndex,
		/*out*/ UInt64* pullPacketsDropped ) = 0;
	/// Reset adapter.
	HE_IMETHOD ResetAdapter(/*in*/ UInt32 nAdapterIndex) = 0;
	/// Create or reference a live packet feed from adapter.
	HE_IMETHOD CreatePacketFeed(/*in*/ UInt32 nAdapterIndex) = 0;
	/// Dereference or destroy live packet feed from adapter.
	HE_IMETHOD DestroyPacketFeed(/*in*/ UInt32 nAdapterIndex) = 0;
	/// Create new capture context.
	HE_IMETHOD CreateCapture(/*in*/ const Helium::HeID& id,
		/*in*/ Helium::HEBSTR bstrAdapterName,
		/*in*/ Helium::HEBSTR bstrCaptureName,
		/*in*/ Helium::HEBSTR bstrOwner,
		/*in*/ Helium::HEBSTR bstrFilter,
		/*in*/ UInt64 nCaptureFlags,
		/*in*/ UInt64 nReservedUnits,
		/*out*/ UInt64* pnCaptureID,
		/*out*/ UInt64* pnSessionID) = 0;
	/// Remove existing capture context.
	HE_IMETHOD RemoveCapture(/*in*/ UInt64 nCaptureID,
		/*in*/ UInt64 nSessionID) = 0;
	/// Reset existing capture context.
	HE_IMETHOD ResetCapture(/*in*/ UInt64 nCaptureID,
		/*in*/ UInt64 nSessionID) = 0;
	/// Start a new session in specified capture context.
	HE_IMETHOD StartCapture(/*in*/ UInt64 nCaptureID,
		/*out*/ UInt64* pnSessionID) = 0;
	/// Stop capture session.
	HE_IMETHOD StopCapture(/*in*/ UInt64 nCaptureID,
		/*in*/ UInt64 nSessionID) = 0;
	/// Get the capture status info.
	HE_IMETHOD GetCaptureStatus(/*in*/ UInt64 nCaptureID,
		/*in*/ UInt64 nSessionID,
		/*out*/ PeekCaptureState* pCaptureState,
		/*out*/ RemoteStopReason* pStopReason,
		/*out*/ UInt64* pullPacketsReceived,
		/*out*/ UInt64* pullPacketsFiltered,
		/*out*/ UInt64* pullPacketsDropped) = 0;
	/// Delete a capture.
	HE_IMETHOD DeleteCapture(/*in*/ UInt64 nCaptureID) = 0;
	/// Delete all captures.
	HE_IMETHOD DeleteAllCaptures() = 0;
};
...
#define DagUtil_CID \
{ 0x6D2E5E43, 0x79D2, 0x4289, {0x82, 0xF0, 0x0B, 0xDB, 0x18, 0x70, 0x73, 0xC3} }
...
#define RemoteCaptureManager_CID \
{ 0x4F36E719, 0x244E, 0x4D4F, {0x89, 0xAE, 0x17, 0x1D, 0x56, 0x30, 0xCB, 0xC7} }

#define OmniStoragePacketBuffer_CID \
{ 0x2EA0076C, 0xE109, 0x479D, {0xAA, 0x04, 0x78, 0xC9, 0xCB, 0x80, 0x24, 0xA4} }
