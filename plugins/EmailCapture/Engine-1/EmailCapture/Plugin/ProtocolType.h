...
public:
	;		CProtocolType::CProtocolType() : m_Type( kProtocol_SMTP ) {}
	;		CProtocolType::CProtocolType( tProtocolTypes inType ) : m_Type( inType ) {}
	;		CProtocolType::CProtocolType( PROTOSPEC_ID inId )
