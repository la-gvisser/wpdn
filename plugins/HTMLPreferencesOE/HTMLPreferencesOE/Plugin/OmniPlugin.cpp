...
#if (OE_SERIAL==1)
GUID			g_PluginId = { 0x951D6289, 0x4591, 0x4BE1, { 0xB0, 0xB2, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11 } };
CPeekString		COmniPlugin::s_strName( L"HTMLPrefsOE-1" );
#ifdef _WIN32
...
#endif // _WIN32
#elif (OE_SERIAL==2)
GUID			g_PluginId = { 0x951D6289, 0x4591, 0x4BE1, { 0xB0, 0xB2, 0x22, 0x22, 0x22, 0x22, 0x22, 0x22 } };
CPeekString		COmniPlugin::s_strName( L"HTMLPrefsOE-2" );
#ifdef _WIN32
...
#endif // _WIN32
#elif (OE_SERIAL==3)
GUID			g_PluginId = { 0x951D6289, 0x4591, 0x4BE1, { 0xB0, 0xB2, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33 } };
CPeekString		COmniPlugin::s_strName( L"HTMLPrefsOE-3" );
#ifdef _WIN32
...
#endif // _WIN32
#elif (OE_SERIAL==4)
GUID			g_PluginId = { 0x951D6289, 0x4591, 0x4BE1, { 0xB0, 0xB2, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44 } };
CPeekString		COmniPlugin::s_strName( L"HTMLPrefsOE-4" );
#ifdef _WIN32
...
#endif // _WIN32
#else
GUID			g_PluginId = { 0x951D6289, 0x4591, 0x4BE1, { 0xB0, 0xB2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } };
CPeekString		COmniPlugin::s_strName( L"HTMLPreferencesOE" );
#ifdef _WIN32
...
CPeekString		COmniPlugin::s_strPublisher( L"LiveAction" );
	...
	CRemotePlugin*	inRemotePlugin )
{
	...
	//   %ALLUSERSPROFILE\Application Data\Savvius\Plugins\HTMLPrefsOE-About.zip
	//   %ALLUSERSPROFILE\Application Data\Savvius\Plugins\HTMLPrefsOE-Options.zip
	//   %ALLUSERSPROFILE\Application Data\Savvius\Plugins\HTMLPrefsOE-Tab.zip
...
COmniPlugin::OnGetOptionsHandlerId(
	CGlobalId&	outId )
{
#ifdef USE_LIBRARY_HANDLER
	outId = g_idDlgHandler;
#else
	outId = g_idHTMLHandler;
#endif
