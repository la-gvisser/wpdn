...
public:
	...
	enum PeekSecurityType
	{
		...
		peekSecuritySourceConfig	///< Security alert source config.
	};
	...
	HE_IMETHOD LogSecurityEvent(/*in*/ UInt64 nTimestamp, /*in*/ UInt64 nIDSID, /*in*/ const wchar_t* pszIDSName, /*in*/ const wchar_t* pszCVEID, 
	...
	HE_IMETHOD QuerySecurityConfig(/*in*/ IPeekSecurity::PeekSecurityType type,  /*out*/ Helium::HEBSTR* pbstrJsonConfig) = 0;
	HE_IMETHOD SaveSecurityConfig(/*in*/ IPeekSecurity::PeekSecurityType type, /*in*/ Helium::HEBSTR bstrJsonConfig) = 0;

	/// Query for updated security configuration 
	/// return changed configuration info in JSON format; empty if unchanged
	HE_IMETHOD QuerySecurityUpdates(/*out*/ Helium::HEBSTR* pbstrJsonConfig) = 0;
};
