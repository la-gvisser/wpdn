...
public:
	...
	{
		return static_cast<T*>(HeQIPtrAssign( (Helium::IHeUnknown**) &p, q, T::GetIID() ));
	}
...
//	}
	...
	{
		return (_NoAddRefReleaseOnCHePtr<T>*)p;
	}
...
public:
	...
	T* operator=( T* pT ) throw()
	{
		return static_cast<T*>(HePtrAssign( (Helium::IHeUnknown**) &(this->p), pT ));
	}

	T* operator=( const CHeQIPtr<T>& t ) throw()
	{
		return static_cast<T*>(HePtrAssign( (Helium::IHeUnknown**) &(this->p), t.p ));
	}

	T* operator=( Helium::IHeUnknown* pUnk ) throw()
	{
		return static_cast<T*>(HeQIPtrAssign( (Helium::IHeUnknown**) &(this->p), pUnk, T::GetIID() ));
	}
};
...
public:
	...
	Helium::IHeUnknown* operator=( Helium::IHeUnknown* pUnk ) throw()
	{
        if ( *this != pUnk )
        {
			return HePtrAssign( (Helium::IHeUnknown**) &(this->p), pUnk );
        }
        return *this;
	}
	...
	Helium::IHeUnknown* operator=( const CHeQIPtr<Helium::IHeUnknown>& t ) throw()
	{
        if ( *this != t )
        {
			return HePtrAssign( (Helium::IHeUnknown**) &(this->p), t.p );
        }
        return *this;
	}
};
