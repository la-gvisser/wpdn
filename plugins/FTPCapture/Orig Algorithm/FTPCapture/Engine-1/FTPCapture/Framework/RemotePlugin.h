...
protected:
	static CPeekProxy	s_PeekProxy;
	static COmniPlugin	s_Plugin;
	static CConsoleSend	s_ConsoleSend;
	static CConsoleUI	s_ConsoleUI;
...
protected:
	...
	bool			HasContext() const { return (m_spContext != NULL); }
	bool			HasContextId() const { return m_idContext.IsValid(); }
	bool			HasSite() const { return (m_spUnkSite != NULL); }

	void			InvalidateContextId() { m_idContext = GUID_INVALID; }
...
public:
	static COmniPlugin&	GetPlugin() { return s_Plugin; }
...
public:
	static CConsoleSend	GetConsoleSend() { return s_ConsoleSend; }
	static CConsoleUI	GetConsoleUI() { return s_ConsoleUI; }
...
public:
	...
	// IPluginRecv
public:
	HeResult		SendPluginMessage( CGlobalId inContextId,
...
public:
	...
	HE_IMETHOD		GetUIInfo( Helium::HEBSTR* outCommand,
