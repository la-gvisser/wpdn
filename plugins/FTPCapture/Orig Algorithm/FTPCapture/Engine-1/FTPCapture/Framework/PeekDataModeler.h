...
typedef NSTR1::shared_ptr<CPeekXmlTransfer>	CPeekXmlTransferPtr;
...
public:
	;		CPeekXmlLoad( PCWSTR inName, bool inAsync = false, bool inProcInstr = false ) { Create( inName, inAsync, inProcInstr ); }
...
public:
	;		CPeekXmlStore( PCWSTR inName, bool inAsync = false, bool inProcInstr = false ) { Create( inName, inAsync, inProcInstr ); }
...
public:
	;		CPeekDataModeler( PCWSTR inName, bool inAsync = false, bool inProcInstr = false  )
	{
