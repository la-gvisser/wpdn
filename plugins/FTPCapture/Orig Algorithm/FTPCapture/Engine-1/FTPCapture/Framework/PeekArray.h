...
//	PeekArray.h
//
// This is based from the C_AtlArray class.  The CPeekArrayDep functions are 
// identical to C_AtlArray functions but without Traits.  Private data members 
// have been made protected in order to allow modifying the array behavior.
// =============================================================================
