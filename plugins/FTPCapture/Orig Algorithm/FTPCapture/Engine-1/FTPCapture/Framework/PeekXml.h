...
public:
	...
	{
#if _DEBUG
		ASSERT( Validate( inDocument, inElement ) );
#endif
		if ( inDocument ) {
	...
	bool		GetAttribute( PCWSTR inName, HeLib::CHeVariant& outAttribute, Helium::HEVARTYPE inType = Helium::HE_VT_BSTR );
	...
	CPeekString	GetName();
	bool		GetValue( HeLib::CHeVariant& outValue, Helium::HEVARTYPE inType = Helium::HE_VT_BSTR );
