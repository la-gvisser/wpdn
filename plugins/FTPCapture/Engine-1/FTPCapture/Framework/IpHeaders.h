...
public:
	...
	T				Inverse() { return T( m_Destination, m_Source ); }
	void			Invert() {
...
public:
	...
	static ULONG	Hash( const CIpAddressPortPair& inIpPortPair ) { return static_cast<ULONG>( inIpPortPair.Hash() ); }
};
...
public:
	...
	UInt16			GetPayloadLength() const { return NETWORKTOHOST16( m_Header.TotalLength ); }
