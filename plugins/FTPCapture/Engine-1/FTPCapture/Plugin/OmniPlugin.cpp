...
GUID			g_PluginId = { 0x1DB0C9D7, 0x928, 0x4E9D, { 0xB9, 0x4D, 0x85, 0x31, 0x8C, 0x54, 0x64, 0x1 } };
CGlobalId		COmniPlugin::s_idClass( g_PluginId );
CPeekString		COmniPlugin::s_strName( L"FTPCaptureOE" );
  ...
  #endif // IMPLEMENT_PLUGINMESSAGE
{
	...
	strPrefsFilePath << L"\\FTPCapture.xml";
...
COmniPlugin::OnOptions()
{
	...
	theOptionsDlg.SetOptions( m_Options );
