...
//	hlexcept.h
// =============================================================================
//	Copyright (c) 2005-2010 WildPackets, Inc. All rights reserved.
...
HE_NOINLINE inline void HeThrowIfFailed( const HeResult hr )
{
...
/// \param hr The error code you want to check/throw.
HE_NOINLINE inline void HeThrowIfNotOK( const HeResult hr )
{
	if ( HE_FAILED(hr) ) HeLib::HeThrow( hr );
...
HE_NOINLINE inline void HeThrowIf( const bool b, const HeResult hr = HE_E_FAIL )
{
...
HE_NOINLINE inline void HeThrowIfNull( const void* p, const HeResult hr = HE_E_NULL_POINTER )
{
...
HE_NOINLINE inline void HeThrowIfError( const int x )
{
...
/// a CHeLibException.
/// \param x The return code you want to check.
HE_NOINLINE inline void HeThrowIfEOF( const int x )
{
...
HE_NOINLINE inline void HE_NORETURN HeThrowWin32( const DWORD dwWin32Err )
{
	HeLib::HeThrow( Helium::HeResultFromWin32( dwWin32Err ) );
}

/// \brief Throw the result of GetLastError().
HE_NOINLINE inline void HE_NORETURN HeThrowLastWin32()
{
