...
public:
	...
	bool GetRadiusInfo( CLayerUDP& inLayerUDP, COptions& inOptions );
...
//	}
	...
	void	SetIPAddresses( UInt32 inSrcAddress, UInt32 inDstAddress ) {
		m_uSrcAddr = inSrcAddress;
		m_uDstAddr = inDstAddress;
	}

	protected:
		bool				ParseForRadius( const UInt8* pUDPData );
