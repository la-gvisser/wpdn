...
struct HeID
{
	...
	{
		return 
			((((UInt32*) &Data1)[0] == ((UInt32*) &other.Data1)[0]) &&
			 (((UInt32*) &Data1)[1] == ((UInt32*) &other.Data1)[1]) &&
			 (((UInt32*) &Data1)[2] == ((UInt32*) &other.Data1)[2]) &&
			 (((UInt32*) &Data1)[3] == ((UInt32*) &other.Data1)[3]));
	}
	...
	inline bool ToString( char* sz, std::size_t cchMax ) const
	{
	...
	/// Converts an id into a string of printable characters of the form
	/// {xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx}.
	inline bool ToString( wchar_t* sz, std::size_t cchMax ) const
	{
		if ( sz == NULL ) return false;
		if ( cchMax < string_length ) return false;
	...
	{
		const UInt32* p = reinterpret_cast<const UInt32*>(this);
		return static_cast<std::size_t>(p[0]^p[1]^p[2]^p[3]);
	}
} HE_PACK_STRUCT;
#include "hepoppack.h"
