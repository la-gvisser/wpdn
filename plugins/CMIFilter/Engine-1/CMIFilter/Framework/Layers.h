...
public:
	;		CLayer() : m_pPacket( nullptr ), m_nType( 0 ) {}
...
public:
	...
	bool			IsNotValid() const { return (m_pHeaderRef == nullptr); }
	bool			IsValid() const { return (m_pHeaderRef != nullptr); }

	// IPeekHash
	size_t			Hash() const { return (m_pHeaderRef != nullptr) ? m_pHeaderRef->Hash() : 0; }
};
...
public:
	...
	UInt16					GetDestinationPort() const { return m_HeaderRef.GetDestinationPort(); }
	CUdpHeader				GetHeader() const { return CUdpHeader( m_HeaderRef ); }
	const CUdpHeaderRef&	GetHeaderRef() const { return m_HeaderRef; }
	UInt16					GetLength() const { return m_HeaderRef.GetLength(); }
	UInt16					GetSourcePort() const { return m_HeaderRef.GetSourcePort(); }
