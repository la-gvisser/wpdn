...
protected:
	bool	GetSummaryItems( size_t inIndex, CPeekString& outGroup,
				 CPeekString& outLabel, CGlobalId& outGroupId,
				CGlobalId& outLabelId, PeekSummaryStat& outSummaryStat );
	bool	TranslateSummaryValue( const SSummaryStatEntryPtr inStatEntry,
