	...
	PluginLoadParam*	ioParams )
{
	...
	else if ( ioParams->fAPIVersion == kPluginAPIVersion11 ) {
		m_APIVersion = kPluginAPIVersion11;
	}
	else if ( ioParams->fAPIVersion == kPluginAPIVersion10 ) {
		m_APIVersion = kPluginAPIVersion10;
	}
	else {
		return PLUGIN_RESULT_ERROR;
	}
