...
//	omnicommands.h
// =============================================================================
//	Copyright (c) 2003-2010	WildPackets, Inc. All rights reserved.
...
namespace OmniProtocolCommands
{
	...
	const UInt32 OMNI_GET_EXPERT_SETTINGS						= 134;
	const UInt32 OMNI_SET_EXPERT_SETTINGS						= 135;
...
//	const UInt32 OMNI_GET_LOGGEDON_USERS						= 511;		// Never used, never implemented.
//	const UInt32 OMNI_LOGOFF_USERS								= 512;		// Never used, never implemented.
...
//	const UInt32 OMNI_GET_DATA_DIR								= 517;		// Never used, never implemented.
//	const UInt32 OMNI_SET_DATA_DIR								= 518;		// Never used, never implemented.
...
//	const UInt32 OMNI_ADMCMD_GET_COMMAND_LIST					= 522;		// Obsolete, use OMNI_GET_COMMAND_LIST
	...
	const UInt32 OMNI_OMNI_CAPTURE_COMMAND						= 530;
