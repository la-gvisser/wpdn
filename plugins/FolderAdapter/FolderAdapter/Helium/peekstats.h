...
/// \internal
/// \interface IResetIntervalStats
/// \brief Objects that can reset interval statistics.
#define IResetIntervalStats_IID \
{ 0xE1A38CC9, 0x86E3, 0x4611, {0x91, 0x77, 0x1E, 0x05, 0xEF, 0xE4, 0x00, 0xB5} }

class HE_NO_VTABLE IResetIntervalStats : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IResetIntervalStats_IID)

	/// Reset the interval statistics.
	HE_IMETHOD ResetIntervalStats() = 0;
};
...
/// \brief Query a stats context for data as used by Peer Map.
/// \see IPeekStatsContext
#define IQueryStats_IID \
{ 0x68A8392F, 0x9A8C, 0x47B6, {0x99, 0x45, 0x69, 0x48, 0x74, 0x0A, 0x31, 0x9D} }

class HE_NO_VTABLE IQueryStats : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IQueryStats_IID)

	/// Query the stats context.
	/// \param pStatsContext Stats context
	/// \param pRequest JSON value with request parameters
	/// \param pResponse JSON value to receive the response
	HE_IMETHOD Query(/*in*/ IPeekStatsContext* pStatsContext,
		/*in*/ Helium::IHeUnknown* pRequest, /*in*/ Helium::IHeUnknown* pResponse) = 0;
};
...
public:
	...
	HE_IMETHOD EntityToIndex(/*in*/ TMediaSpecClass msc, /*in*/ TMediaSpecType mst,
		/*in*/ const UInt8* pEntity, /*in*/ UInt16 nDataSize,
		/*in*/ BOOL bAddIfNotFound, /*in*/ UInt64 nTimeStamp, /*out*/ UInt32* pulIndex) = 0;
	HE_IMETHOD IndexToEntity(/*in*/ UInt32 ulIndex,
		/*out*/ UInt8* pEntity, /*in*/ UInt16 nDataSize, /*out*/ UInt64* pullTimeStamp) = 0;
};
...
/// \brief Dashboard history statistics.
...
/// \internal
/// \interface IApplicationFlowStats
/// \brief Application flow counts.
#define IApplicationFlowStats_IID \
{ 0xA622BA69, 0xCFBC, 0x487D, {0xA9, 0x75, 0xD9, 0x82, 0x7A, 0xEE, 0x91, 0x5E} }

class HE_NO_VTABLE IApplicationFlowStats : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IApplicationFlowStats_IID)

	/// Query the stats for results.
	HE_IMETHOD Query(/*in*/ Helium::IHeStream* pStream) = 0;
};

/// \internal
/// \interface IApplicationHistoryStats
/// \brief Application history statistics.
#define IApplicationHistoryStats_IID \
{ 0xA64A1743, 0x0AF7, 0x4F82, {0x8B, 0xD7, 0xEE, 0x30, 0x22, 0xD4, 0x80, 0xE5} }

class HE_NO_VTABLE IApplicationHistoryStats : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IApplicationHistoryStats_IID)

	/// Get the sample interval in seconds.
	HE_IMETHOD GetSampleInterval(/*out*/ UInt32* pnSampleInterval) = 0;
	/// Set the sample interval in seconds. Do this before processing.
	HE_IMETHOD SetSampleInterval(/*in*/ UInt32 nSampleInterval) = 0;
	/// Get the sample max count.
	HE_IMETHOD GetMaxSamples(/*out*/ UInt32* pnMaxSamples) = 0;
	/// Set the sample max count.
	HE_IMETHOD SetMaxSamples(/*in*/ UInt32 nMaxSamples) = 0;
	/// Get the sample start time.
	HE_IMETHOD GetSampleStartTime(/*out*/ UInt64* pStartTime) = 0;
	/// Get the sample end time.
	HE_IMETHOD GetSampleEndTime(/*out*/ UInt64* pEndTime) = 0;
	/// Get the sample count.
	HE_IMETHOD GetSampleCount(/*out*/ UInt32* pnSamples) = 0;
	/// Query the stats for top 10 results.
	HE_IMETHOD Query(/*in*/ Helium::IHeStream* pStream) = 0;
};

/// \internal
/// \interface IApplicationHistoryDashboardStats
/// \brief Application history dashboard statistics.
#define IApplicationHistoryDashboardStats_IID \
{ 0x8AF9CFEB, 0x4958, 0x4D5F, {0x9D, 0x4C, 0x7B, 0xDD, 0xFE, 0xDB, 0x9A, 0xAA} }

class HE_NO_VTABLE IApplicationHistoryDashboardStats : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IApplicationHistoryDashboardStats_IID)

	/// Get the current application history stats.
	HE_IMETHOD GetCurrentStats(/*out*/ IApplicationHistoryStats** ppStats) = 0;
};

/// \internal
/// \interface IApplicationResponseTimeStats
/// \brief Application response time statistics.
#define IApplicationResponseTimeStats_IID \
{ 0xE479B7C3, 0x4E0D, 0x470B, {0x8F, 0x00, 0xE9, 0x7A, 0x60, 0xE5, 0xC8, 0xF9} }

class HE_NO_VTABLE IApplicationResponseTimeStats : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IApplicationResponseTimeStats_IID)
...
/// \internal
/// \interface IApplicationResponseTimeDashboardStats
/// \brief Application response time dashboard history statistics.
#define IApplicationResponseTimeDashboardStats_IID \
{ 0x864423A7, 0xC70B, 0x4675, {0xA0, 0x69, 0xA5, 0x50, 0x64, 0xE5, 0xCA, 0xF6} }

class HE_NO_VTABLE IApplicationResponseTimeDashboardStats : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IApplicationResponseTimeDashboardStats_IID)

	/// Get the current application response time stats.
	HE_IMETHOD GetCurrentStats(/*out*/ IApplicationResponseTimeStats** ppStats) = 0;
};
...
/// \internal
/// \struct PeekApplicationStat
/// \brief Basic application stats.
/// \see IApplicationStats
#include "hepushpack.h"
struct PeekApplicationStat
{
	UInt64		FirstTime;	///< First time this application was seen in nanoseconds since midnight 1/1/1601 UTC.
	UInt64		LastTime;	///< Last time this application was seen in nanoseconds since midnight 1/1/1601 UTC.
	UInt64		Packets;	///< Total packets using this application.
	UInt64		Bytes;		///< Total bytes using this application.
} HE_PACK_STRUCT;
#include "hepoppack.h"

/// \internal
/// \struct PeekApplicationStatEntry
/// \brief An entry in the application stats.
/// \see IProtocolStats
#include "hepushpack.h"
struct PeekApplicationStatEntry
{
	UInt32				EntityIndex;	///< Entity table index for the application.
	UInt32				NextIndex;		///< Next stat index (used internally).
	PeekApplicationStat	Stat;			///< Statistics for this application.
} HE_PACK_STRUCT;
#include "hepoppack.h"
...
/// \see coclass ApplicationStats
#define IApplicationStats_IID \
{ 0xD60C4EB1, 0x616B, 0x4C0E, {0x9D, 0x65, 0xF7, 0x40, 0x8F, 0x28, 0xB7, 0xBD} }

class HE_NO_VTABLE IApplicationStats : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IApplicationStats_IID)
	...
	HE_IMETHOD GetCount(/*out*/ UInt32* pulCount) = 0;
	/// Find a application stat.
	HE_IMETHOD Find(/*in*/ UInt32 ulEntityIndex, /*out*/ UInt32* pulStatIndex) = 0;
	/// Get a application stat entry by index.
	HE_IMETHOD IndexToStats(/*in*/ UInt32 ulStatIndex, /*out*/ PeekApplicationStatEntry* pStatEntry) = 0;
};

#include "hepushpack.h"
struct PeekCountryStat
{
	char		CountryCode[2];	///< ISO 3661-1 Alpha 2 Country Code.
	char		Padding[6];
	UInt64		FirstTimeFrom;	///< First time seen from this country.
	UInt64		LastTimeFrom;	///< Last time seen from this country.
	UInt64		PacketsFrom;	///< Packets from this country.
	UInt64		BytesFrom;		///< Bytes from this country.
	UInt64		FirstTimeTo;	///< First time seen to this country.
	UInt64		LastTimeTo;		///< Last time seen to this country.
	UInt64		PacketsTo;		///< Packets to this country.
	UInt64		BytesTo;		///< Bytes to this country.
} HE_PACK_STRUCT;
#include "hepoppack.h"
...
/// \see coclass CountryStats
#define ICountryStats_IID \
{ 0x7FD6796E, 0x6FF3, 0x43FC, {0x81, 0xE8, 0x85, 0x57, 0x14, 0x8F, 0xE8, 0x99} }

class HE_NO_VTABLE ICountryStats : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(ICountryStats_IID)

	/// Get the stat count.
	HE_IMETHOD GetCount(/*out*/ UInt32* pCount) = 0;
	/// Get a copy of all of the stats.
	HE_IMETHOD GetStats(/*in,out*/ UInt32* pCount, /*out*/ PeekCountryStat* payStats) = 0;
	/// Get a single stat by country code.
	HE_IMETHOD GetStat(/*in*/ const char code[2], /*out*/ PeekCountryStat* pStat) = 0;
};
...
union PeekSummaryStatValue
{
	...
	SInt64						Duration;		///< Duration in nanoseconds.
	UInt64						Packets;		///< Packet count.
	UInt64						Bytes;			///< Byte count.
...
/// \internal
/// \enum PeekApplicationStatType
/// \brief Application stats value types.
/// \see PeekApplicationStat
enum PeekApplicationStatType
{
	peekApplicationStatTypeNull,		///< None
	peekApplicationStatTypePackets,		///< Total packets using this application.
	peekApplicationStatTypeBytes		///< Total bytes using this application.
};

/// \internal
/// \interface IApplicationStatsTracker
/// \brief Application statistics tracking item.
#define IApplicationStatsTracker_IID \
{ 0x4A708AF7, 0x789E, 0x45C8, {0xB3, 0x40, 0xB7, 0xFE, 0x4D, 0x73, 0x85, 0x11} }

class HE_NO_VTABLE IApplicationStatsTracker : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IApplicationStatsTracker_IID)
	...
	HE_IMETHOD SetMediaSpec(/*in*/ TMediaSpec MediaSpec) = 0;
	/// Get the stat type.
	HE_IMETHOD GetType(/*out*/ PeekApplicationStatType* pType) = 0;
	/// Set the stat type.
	HE_IMETHOD SetType(/*in*/ PeekApplicationStatType type) = 0;
};

/// \internal
/// \enum PeekCountryStatType
/// \brief Country stats value types.
/// \see PeekCountryStat
enum PeekCountryStatType
{
	peekCountryStatTypeNull,			///< None
	peekCountryStatTypeTotalPackets,	///< Total packets from/to this country.
	peekCountryStatTypeTotalBytes,		///< Total bytes from/to this country.
	peekCountryStatTypePacketsFrom,		///< Packets from this country.
	peekCountryStatTypeBytesFrom,		///< Bytes from this country.
	peekCountryStatTypePacketsTo,		///< Packets to this country.
	peekCountryStatTypeBytesTo			///< Bytes to this country.
};

/// \internal
/// \interface ICountryStatsTracker
/// \brief Country statistics tracking item.
#define ICountryStatsTracker_IID \
{ 0x2BC0C674, 0x153B, 0x4CC1, {0x8C, 0xDF, 0x52, 0x63, 0x8C, 0x02, 0x02, 0x01} }

class HE_NO_VTABLE ICountryStatsTracker : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(ICountryStatsTracker_IID)

	/// Get the item's country code.
	HE_IMETHOD GetCountryCode(/*out*/ char code[2]) = 0;
	/// Set the item country code.
	HE_IMETHOD SetCountryCode(/*in*/ const char code[2]) = 0;
	/// Get the stat type.
	HE_IMETHOD GetType(/*out*/ PeekCountryStatType* pType) = 0;
	/// Set the stat type.
	HE_IMETHOD SetType(/*in*/ PeekCountryStatType type) = 0;
};
...
enum ColumnSet
{
	...
	COLUMN_SET_MINIMAL			///< Minimal set of columns for flows table - used for stats output consumed by Splunk
};
...
#define ApplicationFlowStats_CID \
{ 0x4224FD28, 0x5996, 0x4C62, {0x8D, 0xCD, 0x3D, 0x61, 0x5E, 0x71, 0xC1, 0xA1} }

#define ApplicationHistoryStats_CID \
{ 0x7B146DC4, 0x3AC5, 0x46BB, {0x99, 0x6B, 0x6D, 0x85, 0xA6, 0x3E, 0x91, 0x91} }

#define ApplicationHistoryDashboardStats_CID \
{ 0x7548DBE5, 0xA180, 0x4A4B, {0xA8, 0x8B, 0x81, 0xEE, 0x45, 0x99, 0x4D, 0x29} }

#define ApplicationResponseTimeStats_CID \
{ 0xA005EDC5, 0xB504, 0x44CE, {0x84, 0xB4, 0x09, 0x0E, 0xC0, 0x30, 0x2F, 0xB4} }

#define ApplicationResponseTimeDashboardStats_CID \
{ 0x64EF540F, 0x1582, 0x4115, {0x86, 0xCD, 0xC1, 0x37, 0x8E, 0xF8, 0x62, 0xAC} }
...
#define CountryStats_CID \
{ 0xBAC56A49, 0x681B, 0x47EC, {0x81, 0xB6, 0x92, 0x3A, 0x93, 0x92, 0xDF, 0xD1} }

#define CountryStatsTracker_CID \
{ 0x5FF04EFD, 0x9A1D, 0x436B, {0xBD, 0x5D, 0x3E, 0x20, 0x62, 0x96, 0xC9, 0x0A} }
...
#define QueryStats_CID \
{ 0x60F81CF8, 0x0371, 0x4D77, {0xA6, 0xBE, 0x83, 0xD4, 0xA1, 0x6E, 0x9E, 0x8C} }
...
#define ApplicationStats_CID \
{ 0x376D6465, 0x31B3, 0x4359, {0x8E, 0x8B, 0xCE, 0x0C, 0xCB, 0xC4, 0xFB, 0x6A} }

#define ApplicationStatsTracker_CID \
{ 0x55E270A, 0xCED1, 0x4A68, { 0xA9, 0x8E, 0xB9, 0xA4, 0xCC, 0xE9, 0x3F, 0xA3} }
