...
/// Web plugins implement this COM category.
#define Category_OmniWebPluginAbout \
{ 0xA5A2F78B, 0xF8BD, 0x41EC, {0x80, 0xB5, 0xF7, 0x41, 0x01, 0x20, 0xAC, 0xD2} }
#define Category_OmniWebPluginOptions \
{ 0x731379BF, 0xFA2E, 0x4389, {0x8D, 0x6E, 0x89, 0x8D, 0xAA, 0x69, 0xA1, 0xBE} }
#define Category_OmniWebPluginCapture \
{ 0x053ABC7A, 0x56F0, 0x49B0, {0x99, 0x74, 0xB5, 0x55, 0x32, 0x54, 0x97, 0xD7} }
#define Category_OmniWebPluginEngine \
{ 0x3D39505C, 0xEB69, 0x4EA9, {0xA9, 0xAC, 0x92, 0x70, 0xAF, 0x39, 0x7E, 0x97} }
#define Category_OmniWebPluginAdapter \
{ 0x6166FE20, 0xD4C6, 0x4B42, {0xBC, 0x71, 0x8F, 0x1A, 0xAB, 0xE7, 0xB5, 0xA2} }
...
/// Interface for receiving notifications when captures are created, etc.
#define IEnginePluginCaptureEvents2_IID \
{ 0xF538727B, 0x3926, 0x4B4F, {0x90, 0xCA, 0x6A, 0xEE, 0x0B, 0xE6, 0x6E, 0x02} }

class HE_NO_VTABLE IEnginePluginCaptureEvents2 : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IEnginePluginCaptureEvents2_IID);

	HE_IMETHOD OnCaptureModified(IHeUnknown* pCapture) = 0;
};
...
public:
	...
	HE_IMETHOD GetDisplayFormat(/*out*/ BOOL* pShowAddressNames, /*out*/ BOOL* pShowPortNames, /*out*/ BOOL* pShowCountryNames, /*out*/ BOOL* pShowLogical, /*out*/ BOOL* pLocalTime) = 0;
	HE_IMETHOD CanViewPackets(/*out*/ BOOL* pCanViewPackets) = 0;
	HE_IMETHOD CanDoForensicSearch(/*out*/ BOOL* pCanDoForensicSearch) = 0;
};
...
public:
	...
	HE_IMETHOD DisplayFormatChanged() = 0;
	HE_IMETHOD HasConsoleUI(/*out*/ BOOL* pbHasConsoleUI) = 0;
};
