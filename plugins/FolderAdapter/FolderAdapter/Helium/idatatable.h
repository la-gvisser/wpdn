...
public:
	...
	HE_IMETHOD GetDataType(/*out*/ Helium::HEVARTYPE* pDataType) = 0;
};

#define IDataTableColumn2_IID \
{ 0x045A1BC8, 0xE89E, 0x4851, {0x96, 0x90, 0x4D, 0xF1, 0xAA, 0xCD, 0xE8, 0x78} }

class HE_NO_VTABLE IDataTableColumn2 : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IDataTableColumn2_IID)

	HE_IMETHOD SetColumnName(/*in*/ const wchar_t* pszColumnName) = 0;
	HE_IMETHOD SetDataType(/*in*/ Helium::HEVARTYPE dataType) = 0;
};
