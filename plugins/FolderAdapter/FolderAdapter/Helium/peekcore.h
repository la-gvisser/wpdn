...
//	peekcore.h
// =============================================================================
//	Copyright (c) 2001-2015 WildPackets, Inc. All rights reserved.
...
public:
	...
	/// Full path to the index database.
	HE_IMETHOD GetIndexDatabasePath(/*out*/ Helium::HEBSTR* pbstrPath) = 0;
	/// Full path to the database directory.
	HE_IMETHOD GetDatabaseDir(/*out*/ Helium::HEBSTR* pbstrDir) = 0;
	/// Location of temp data files.
	HE_IMETHOD GetTempDataDir(/*out*/ Helium::HEBSTR* pbstrDir ) = 0;
};
...
/// \internal
/// \interface IGigAdapterInfo
/// \ingroup Adapter
/// \brief Adapter info.
/// \see IAdapterInfo
#define IGigAdapterInfo_IID \
{ 0xA8AAA6E4, 0x0B92, 0x44C3, {0xA7, 0xE5, 0x94, 0x7A, 0x93, 0xE5, 0xAA, 0x79} }

class HE_NO_VTABLE IGigAdapterInfo : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IGigAdapterInfo_IID);

	/// Get the interface features.
	HE_IMETHOD GetInterfaceFeatures(/*out*/ UInt32* pulInterfaceFeatures) = 0;
	...
	/// Is virtual supported?
	HE_IMETHOD SupportsVirtual(/*out*/ BOOL* pbSupportsVirtual) = 0;
};
...
/// \interface IVirtualAdapter
/// \ingroup Adapter
/// \brief Virtual adapter interface.
/// \see ICapturePackets, ISendPackets, coclass NdisAdapter, coclass ReplayAdapter
#define IVirtualAdapter_IID \
{ 0xE4E8543C, 0x1C87, 0x4396, {0xB9, 0xF3, 0xD7, 0x23, 0xA5, 0x57, 0x99, 0x84} }

class HE_NO_VTABLE IVirtualAdapter : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IVirtualAdapter_IID);

	/// Get the virtual index.
	HE_IMETHOD GetVirtualIndex(/*out*/ UInt32* pnVirtualIndex) = 0;
	/// Set the virtual index.
	HE_IMETHOD SetVirtualIndex(/*in*/ UInt32 nVirtualIndex) = 0;
	/// Is virtual supported?
	HE_IMETHOD SupportsVirtual(/*out*/ BOOL* pbSupportsVirtual) = 0;
	/// Is virtual adapter?
	HE_IMETHOD IsVirtual(/*out*/ BOOL* pbVirtual) = 0;
};
...
public:
	...
	/// Refresh all adapter info state (link up/down, etc.).
	HE_IMETHOD RefreshAdapterState() = 0;
};
...
/// \internal
/// \interface IGigHardwareOptions2
/// \ingroup Adapter
/// \brief Specific Gigabit hardware options.
/// \see coclass GigHardwareOptions
#define IGigHardwareOptions2_IID \
{ 0xBEC0A59D, 0xFC8A, 0x4FC9, {0xA1, 0xCD, 0x09, 0x2D, 0x27, 0x73, 0x98, 0x5E} }

class HE_NO_VTABLE IGigHardwareOptions2 : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IGigHardwareOptions2_IID);

	HE_IMETHOD GetDeduplication(/*out*/ BOOL* pbDeduplication) = 0;
	HE_IMETHOD SetDeduplication(/*in*/ BOOL bDeduplication) = 0;
};

/// \internal
/// \interface IGigHardwareOptions3
/// \ingroup Adapter
/// \brief Specific Gigabit hardware options.
/// \see coclass GigHardwareOptions
#define IGigHardwareOptions3_IID \
{ 0xD956963F, 0x8571, 0x4DE6, {0x99, 0x32, 0x38, 0xB8, 0x40, 0x70, 0xB9, 0xB0} }

class HE_NO_VTABLE IGigHardwareOptions3 : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IGigHardwareOptions3_IID);

	HE_IMETHOD GetSliceOffset(/*out*/ UInt8* pnSliceOffset) = 0;
	HE_IMETHOD SetSliceOffset(/*in*/ UInt8 nSliceOffset) = 0;
};
...
/// \internal
/// \interface IGigHardwareChannelFilter2
/// \ingroup Adapter
/// \brief Specific Gigabit hardware channel filter.
/// \see coclass NapatechHardwareFilter
#define IGigHardwareChannelFilter2_IID \
{ 0xD8DE9D19, 0xCF1F, 0x477F, {0x93, 0xA6, 0xE7, 0x64, 0xA0, 0x30, 0x40, 0x96} }

class HE_NO_VTABLE IGigHardwareChannelFilter2 : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IGigHardwareChannelFilter2_IID);

	/// Is this an MPLS filter?
	HE_IMETHOD GetMPLSFilterEnabled(/*out*/ BOOL* pbMPLSFilter) = 0;
	/// Set whether to filter for MPLS.
	HE_IMETHOD SetMPLSFilterEnabled(/*in*/ BOOL bMPLSFilter) = 0;
	/// Get the MPLS filter.
	HE_IMETHOD GetMPLSFilter(/*out*/ UInt32** ppMPLSLabels, /*out*/ UInt32* pnMPLSLabels, /*out*/ UInt8* pnLayers) = 0;
	/// Set the MPLS filter.
	HE_IMETHOD SetMPLSFilter(/*in*/ UInt32* pMPLSLabels, /*in*/ UInt32 nMPLSLabels, /*in*/ UInt8 nLayers) = 0;
	/// Is this a VLAN filter?
	HE_IMETHOD GetVLANFilterEnabled(/*out*/ BOOL* pbVLANFilter) = 0;
	/// Set whether to filter for VLAN.
	HE_IMETHOD SetVLANFilterEnabled(/*in*/ BOOL bVLANFilter) = 0;
	/// Get the VLAN filter.
	HE_IMETHOD GetVLANFilter(/*out*/ UInt16** ppVLANIDs, /*out*/ UInt32* pnVLANIDs, /*out*/ UInt8* pnLayers) = 0;
	/// Set the VLAN filter.
	HE_IMETHOD SetVLANFilter(/*in*/ UInt16* pVLANIDs, /*in*/ UInt32 nVLANIDs, /*in*/ UInt8 nLayers) = 0;
};

/// \internal
/// \interface IGigHardwareChannelFilterValue
/// \ingroup Adapter
/// \brief Specific Gigabit hardware channel filter value.
/// \see coclass NapatechHardwareFilterValue
#define IGigHardwareChannelFilterValue_IID \
{ 0x85EBA056, 0x77D1, 0x4C74, {0x9A, 0x80, 0x19, 0x57, 0xBA, 0x96, 0xE2, 0x20} }

class HE_NO_VTABLE IGigHardwareChannelFilterValue : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IGigHardwareChannelFilterValue_IID);

	/// Get the 'and' node.
	HE_IMETHOD GetAndNode(/*out*/ IGigHardwareChannelFilterValue** ppValueFilter) = 0;
	/// Set the 'and' node.
	HE_IMETHOD SetAndNode(/*in*/ IGigHardwareChannelFilterValue* pValueFilter) = 0;
	/// Get the ID.
	HE_IMETHOD GetID(/*out*/ Helium::HeID* pID) = 0;
	/// Set the ID.
	HE_IMETHOD SetID(/*in*/ const Helium::HeID& id) = 0;
	/// Get the length, mask and operator.
	HE_IMETHOD GetLengthMaskOperator(/*out*/ UInt8* pnLength, /*out*/ UInt32* pnMask, /*out*/ UInt8* pnOperator) = 0;
	/// Set the length, mask and operator.
	HE_IMETHOD SetLengthMaskOperator(/*in*/ UInt8 nLength, /*in*/ UInt32 nMask, /*in*/ UInt8 nOperator) = 0;
	/// Get the offset.
	HE_IMETHOD GetOffset(/*out*/ UInt8* pnOffset) = 0;
	/// Set the offset.
	HE_IMETHOD SetOffset(/*in*/ UInt8 nOffset) = 0;
	/// Get the offset location.
	HE_IMETHOD GetOffsetLocation(/*out*/ SInt16* pnOffsetLocation) = 0;
	/// Set the offset location.
	HE_IMETHOD SetOffsetLocation(/*in*/ SInt16 nOffsetLocation) = 0;
	/// Get the 'or' node.
	HE_IMETHOD GetOrNode(/*out*/ IGigHardwareChannelFilterValue** ppValueFilter) = 0;
	/// Set the 'or' node.
	HE_IMETHOD SetOrNode(/*in*/ IGigHardwareChannelFilterValue* pValueFilter) = 0;
	/// Get the value.
	HE_IMETHOD GetValue(/*out*/ UInt32* pnValue) = 0;
	/// Set the value.
	HE_IMETHOD SetValue(/*in*/ UInt32 nValue) = 0;
	/// Get the value media spec.
	HE_IMETHOD GetValueMediaSpec(/*out*/ TMediaSpec* pSpec) = 0;
	/// Set the value media spec.
	HE_IMETHOD SetValueMediaSpec(/*in*/ const TMediaSpec* pSpec) = 0;
	/// Build the packet class definition with the value filter.
	HE_IMETHOD BuildValueFilter(/*in/out*/ void* pcf, UInt8& vidx) = 0;
	/// Count the number of value filters.
	HE_IMETHOD CountValueFilters(/*out*/ UInt32* pnCount) = 0;
};

/// \internal
/// \interface IGigHardwareChannelFilter3
/// \ingroup Adapter
/// \brief Specific Gigabit hardware channel filter.
/// \see coclass NapatechHardwareFilter
#define IGigHardwareChannelFilter3_IID \
{ 0x4FA625BB, 0xe72A, 0x49E1, {0x87, 0x3B, 0xD5, 0xA2, 0x0E, 0xB5, 0x27, 0x3C} }

class HE_NO_VTABLE IGigHardwareChannelFilter3 : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IGigHardwareChannelFilter3_IID);

	/// Is this a value filter?
	HE_IMETHOD GetValueFilterEnabled(/*out*/ BOOL* pbValueFilter) = 0;
	/// Set whether to filter for value.
	HE_IMETHOD SetValueFilterEnabled(/*in*/ BOOL bValueFilter) = 0;
	/// Get the value filter.
	HE_IMETHOD GetValueFilter(/*out*/ IGigHardwareChannelFilterValue** ppValueFilter) = 0;
	/// Get the value filter.
	HE_IMETHOD SetValueFilter(/*in*/ IGigHardwareChannelFilterValue* pValueFilter) = 0;
};
...
/// \internal
/// \interface IAdapterList
/// \ingroup Adapter
/// \brief List of adapter.
/// \see IAdapterInfo, IAdapterConfig, IHardwareOptions, coclass AdapterList
#define IAdapterList_IID \
{ 0xEDC86266, 0xDF6A, 0x4CFF, {0xB7, 0xFE, 0x82, 0x7E, 0x5F, 0x38, 0x67, 0xF1} }

class HE_NO_VTABLE IAdapterList : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IAdapterList_IID);

	/// Get adapter properties by index.
	HE_IMETHOD GetItem(/*in*/ SInt32 lIndex, /*out*/ IAdapterInfo** ppAdapterInfo,
		/*out*/ IAdapterConfig** ppAdapterConfig, /*out*/ IHardwareOptions** ppHardwareOptions) = 0;
	/// Get the count of adapter items in the list.
	HE_IMETHOD GetCount(/*out*/ SInt32* pnCount) = 0;
	/// Add adapter.
	HE_IMETHOD Add(/*in*/ IAdapterInfo* pAdapterInfo, /*in*/ IAdapterConfig* pAdapterConfig,
		/*in*/ IHardwareOptions* pHardwareOptions) = 0;
	/// Remove adapter.
	HE_IMETHOD Remove(/*in*/ IAdapterInfo* pAdapterInfo) = 0;
	/// Remove all adapter.
	HE_IMETHOD RemoveAll() = 0;
	/// Find adapter given adapter type and identifier.
	HE_IMETHOD Find(/*in*/ PeekAdapterType type, /*in*/ Helium::HEBSTR bstrIdentifier,
		/*out*/ IAdapterInfo** ppAdapterInfo, /*out*/ IAdapterConfig** ppAdapterConfig,
		/*out*/ IHardwareOptions** ppHardwareOptions) = 0;
};

#define PEEK_E_HARDWARE_PROFILE_IN_USE			((HeResult)	0x80040240L)	///< Hardware profile is in use.
#define PEEK_E_HARDWARE_PROFILE_LIMIT			((HeResult)	0x80040241L)	///< The hardware profile limit has been reached.
#define PEEK_E_HARDWARE_PROFILE_NTPL_FAIL		((HeResult)	0x80040242L)	///< The hardware profile exceeds hardware capabilities.

#define PEEK_E_ADAPTER_MISSING					((HeResult)	0x80040250L)

/// \internal
/// \interface IAdapterManager2
/// \ingroup Adapter
/// \brief Virtual adapter management.
/// \see coclass AdapterManager
#define IAdapterManager2_IID \
{ 0xBC66793F, 0x7942, 0x4893, {0xA4, 0x27, 0x11, 0xC8, 0xFD, 0xE2, 0xDD, 0xEC} }

class HE_NO_VTABLE IAdapterManager2 : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IAdapterManager2_IID);

	/// Get the adapter list.
	HE_IMETHOD GetAdapterList(/*out*/ IAdapterList** ppAdapterList) = 0;
	/// Refresh hardware options.
	HE_IMETHOD RefreshHardwareOptions(/*in*/ IHardwareOptionsCollection* pHardwareOptionsCollection) = 0;
	/// Check if adapters support hardware options collection - make sure all
	/// hardware options being used by adapters are represented.
	HE_IMETHOD ValidateHardwareOptions(/*in*/ IHardwareOptionsCollection* pHardwareOptionsCollection,
		/*out*/ BOOL* pbValid) = 0;
	/// Get a virtual adapter.
	HE_IMETHOD GetVirtualAdapter(/*in*/ PeekAdapterType type,
		/*in*/ Helium::HEBSTR bstrIdentifier, /*in*/ Helium::HEBSTR bstrDescription,
		/*in*/ const Helium::HeID& hardwareProfileId, /*out*/ IAdapter** ppVirtualAdapter) = 0;
	/// Remove a virtual adapter.
	HE_IMETHOD RemoveVirtualAdapter(/*in*/ PeekAdapterType type,
		/*in*/ Helium::HEBSTR bstrIdentifier, /*in*/ Helium::HEBSTR bstrDescription,
		/*in*/ const Helium::HeID& hardwareProfileId) = 0;
	/// Check if virtual adapter exists.
	HE_IMETHOD HasVirtualAdapter(/*in*/ PeekAdapterType type,
		/*in*/ Helium::HEBSTR bstrIdentifier, /*in*/ Helium::HEBSTR bstrDescription,
		/*in*/ const Helium::HeID& hardwareProfileId, /*out*/ BOOL* pHasVirtualAdapter) = 0;
};
...
public:
	...
	/// \param nSessionID Session id of the packet file to filter.
	/// \param nStartTimestamp Start time of the packet file to filter.
	/// \param nStopTimestamp Stop time of the packet file to filter.
	/// \param pFilterID Pointer to the filter's globally unique identifier.
	/// \retval HE_S_OK File is accepted
	/// \retval HE_S_FALSE File is rejected
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER One of the pointers is invalid
	HE_IMETHOD FilterFile(/*in*/ UInt32 nSessionID, /*in*/ UInt64 nStartTimestamp,
		/*in*/ UInt64 nStopTimestamp, /*out*/ Helium::HeID* pFilterID) = 0;
};

/// \interface IFilterSession
/// \ingroup Filter
/// \brief Filter a capture session.
#define IFilterSession_IID \
{ 0x98D3CBBF, 0xC1C2, 0x4F58, {0x80, 0x41, 0x1A, 0x1D, 0x3B, 0x3F, 0x29, 0xA1} }

class HE_NO_VTABLE IFilterSession : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IFilterSession_IID);

	/// Allow the OmniEngine to filter capture sessions.
	/// \param nSessionID Session id of the capture session to filter.
	/// \param pFilterID Pointer to the filter's globally unique identifier.
	/// \retval HE_S_OK Session is accepted
	/// \retval HE_S_FALSE Session is rejected
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER One of the pointers is invalid
	HE_IMETHOD FilterSession(/*in*/ UInt32 nSessionID, /*out*/ Helium::HeID* pFilterID) = 0;
};
...
/// \struct PacketMetaDataAttribute
/// \ingroup Packet
/// \brief A single metadata attribute for a packet.
/// \see IPacketMetaData
#include "hepushpack.h"
struct PacketMetaDataAttribute
{
	UInt16			Context;		///< Protocol dependent transaction context.
	UInt16			Flags;			///< See PeekMetaDataAttributeFlag
	SInt16			Key;			///< Key that identifies the attribute. \see PacketMetaDataInfo
	UInt16			Length;			///< Length of the data pointed to by Value.
	const UInt8*	Value;			///< Pointer to attribute data.
} HE_PACK_STRUCT;
#include "hepoppack.h"

/// \enum PeekMetaDataAttributeFlag
/// \ingroup Packet
/// \brief Flags in PeekMetaDataAttribute.
/// \see PacketMetaDataAttribute
enum PeekMetaDataAttributeFlag
{
	/// The metadata attribute data is a fragment. More data is expected
	/// to complete the content of the metadata attribute.
	peekMetaDataAttributeFlagFragment = 0x0001
};

/// \interface IPacketMetaData
/// \ingroup Packet
/// \brief Access packet metadata associated with a packet.
/// \see PacketMetaDataAttribute, IPacket
#define IPacketMetaData_IID \
{ 0xBFC8FD16, 0x9B75, 0x4612, {0xA6, 0x71, 0xF3, 0x0A, 0xD0, 0x11, 0x61, 0x39} }

class HE_NO_VTABLE IPacketMetaData : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IPacketMetaData_IID);

	/// Get the count of attributes.
	HE_IMETHOD GetCount(/*out*/ UInt32* pCount) = 0;
	/// Get an attribute by index.
	HE_IMETHOD GetAttribute(/*in*/ UInt32 index, /*out*/ PacketMetaDataAttribute** ppAttr) = 0;
};

/// \struct PacketMetaDataInfo
/// \ingroup Packet
/// \brief Used to register for packet metadata.
/// \see IRegisterPacketMetaData
#include "hepushpack.h"
struct PacketMetaDataInfo
{
	SInt16			Key;	///< On output, a Key that will identify the attribute in PacketMetaDataAttribute.
	const char*		Name;	///< Name of the metadata attribute requested.
} HE_PACK_STRUCT;
#include "hepoppack.h"

/// \interface IRegisterPacketMetaData
/// \ingroup Packet
/// \brief Register for packet metadata.
/// \see PacketMetaDataInfo
#define IRegisterPacketMetaData_IID \
{ 0x9C4B0CF8, 0xDD1F, 0x49BE, {0xA0, 0xFE, 0x8A, 0x79, 0xFD, 0xD9, 0xCF, 0x46} }

class HE_NO_VTABLE IRegisterPacketMetaData : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IRegisterPacketMetaData_IID);

	/// Register for packet metadata. Should be called for a capture in OnStartPacketProvider or OnStartPacketStreamProvider.
	HE_IMETHOD RegisterPacketMetaData(/*in*/ UInt32 nInfo, /*in,out*/ PacketMetaDataInfo pInfo[]) = 0;
};
...
public:
	...
	/// Set all packet layers.
	/// \param nLayerCount The number of layers.
	/// \param pLayerInfo An array of PacketLayerInfo structures.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// of layers in the packet.
	/// \retval HE_E_INVALID_POINTER One of the pointers is invalid.
	/// \remarks None
	HE_IMETHOD SetPacketLayers(/*in*/ UInt32 nLayerCount,
		/*in*/ const PacketLayerInfo pLayerInfo[]) = 0;

	/// Get the start and end pointers to TCP options.
	HE_IMETHOD GetTCPOptionBeginAndEnd(/*out*/ const UInt8** ppBegin, /*out*/ const UInt8** ppEnd) = 0;

	/// Get packet metadata.
	HE_IMETHOD GetMetaData(/*out*/ IPacketMetaData** ppMetaData) = 0;
	/// Set packet metadata.
	HE_IMETHOD SetMetaData(/*in*/ IPacketMetaData* pMetaData) = 0;

	/// Set the packet number.
	HE_IMETHOD SetPacketNumber(/*in*/ UInt64 nPacketNumber) = 0;

	/// Get the VLAN IDs.
	/// \param pIDs Array that receives the VLAN IDs.
	/// \param pnIDs On input, the size of the VLAN ID buffer. On output, the number of
	/// VLAN IDs returned in pIDs.
	HE_IMETHOD GetVLANIDs2(/*out*/ UInt16* pIDs, /*in,out*/ UInt32* pnIDs) = 0;
	/// Get the MPLS Labels.
	/// \param pLabels Array that receives the MPLS Labels.
	/// \param pnLabels On input, the size of the MPLS Labels buffer. On output, the number of
	/// MPLS Labels returned in pLabels.
	HE_IMETHOD GetMPLSLabels2(/*out*/ UInt32* pLabels, /*in,out*/ UInt32* pnLabels) = 0;
};
...
/// \interface ISetPacketStatus
/// \ingroup PacketBuffer
/// \brief Change packet status for a range of packets in a packet buffer.
/// \see IPacketBuffer
#define ISetPacketStatus_IID \
{ 0x1B0B300D, 0x46BB, 0x4422, {0x98, 0xD6, 0xC1, 0xB1, 0x39, 0xF2, 0x9D, 0x6B} }

class HE_NO_VTABLE ISetPacketStatus : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(ISetPacketStatus_IID);

	enum SetPacketStatusOption
	{
		setPacketStatusOptionNone,			///< Apply to indicated packets.
		setPacketStatusOptionClearOthers	///< Clear the mask in packets not in range.
	};

	/// Set the status for a range of packets.
	HE_IMETHOD SetPacketStatus(/*in*/ UInt32 mask, /*in*/ UInt32 value,
		/*in*/ SetPacketStatusOption options,
		/*in*/ UInt32 cRanges, /*in*/ UInt64* pRanges) = 0;
};
...
/// \internal
/// \interface IPacketSegment2
/// \ingroup PacketHandler
/// \brief A segment containing a small number of packets
#define IPacketSegment2_IID \
{ 0x49434388, 0xE0B7, 0x4CBA, {0xA9, 0x41, 0x3A, 0xB9, 0x7D, 0x69, 0x54, 0xE9} }

class HE_NO_VTABLE IPacketSegment2 : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IPacketSegment2_IID)

	HE_IMETHOD GetCount(/*out*/ UInt32* pnCount) = 0;
	HE_IMETHOD GetPacket(/*in*/ UInt32 nIndex, /*in*/ IPacket* pPacket) = 0;
	HE_IMETHOD GetPacket2(/*in*/ UInt32 nIndex,
		/*out*/ const PeekPacket** ppPacketHeader, /*out*/ const UInt8** ppPacketData) = 0;
	HE_IMETHOD GetPacketInHashRange(/*in*/ UInt32 nIndex,
		/*in*/ UInt32 nHashLower, /*in*/ UInt32 nHashRange,
		/*in*/ IPacket* pPacket) = 0;
	HE_IMETHOD GetTimeStamp(/*out*/ UInt64* pTimeStamp) = 0;
	HE_IMETHOD GetSegmentData(/*out*/ const UInt8** ppData, /*out*/ size_t* pcbData) = 0;
};
...
public:
	...
	HE_IMETHOD AddStages(/*in*/ IPacketSegmentPipelineStage* pStages[], /*in*/ UInt32 nStages) = 0;
	HE_IMETHOD RemoveStages(/*in*/ IPacketSegmentPipelineStage* pStages[], /*in*/ UInt32 nStages) = 0;
};
...
public:
	...
	// Calculate a rough estimate of how long it will take to perform a forensic search of the given time range
	HE_IMETHOD EstimateForensicSearchTime(/*in*/ UInt64 starttime, /*in*/ UInt64 endtime, /*out*/ Helium::HEBSTR* pbstrJsonConfig) = 0;
...
/// \internal
/// \interface IProtocolTranslationsManager
/// \ingroup ProtocolTranslations
/// \brief Handle port to protocol translations.
#define IProtocolTranslationsManager_IID \
{ 0xCE8A2A23, 0x0F9C, 0x4C2F, {0xA7, 0x79, 0x59, 0x32, 0xC7, 0x65, 0xCD, 0x5E} }

class HE_NO_VTABLE IProtocolTranslationsManager : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IProtocolTranslationsManager_IID);
...
/// \ingroup License
/// \brief Handle license settings.
#define ILicenseManager_IID \
{ 0xEB755BA7, 0x9FCB, 0x4498, {0x97, 0xA7, 0xBB, 0x41, 0x49, 0xA2, 0x47, 0x89} }

class HE_NO_VTABLE ILicenseManager : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(ILicenseManager_IID);

	/// Get the license id.
	HE_IMETHOD GetLicenseId(/*out*/ Helium::HEBSTR* pbstrLicenseId) = 0;
	/// Get the product key.
	HE_IMETHOD GetProductKey(/*out*/ Helium::HEBSTR* pbstrProductKey) = 0;
	/// Set the license id.
	HE_IMETHOD SetLicenseId(/*in*/ Helium::HEBSTR bstrLicenseId) = 0;
	/// Set the product key.
	HE_IMETHOD SetProductKey(/*in*/ Helium::HEBSTR bstrProductKey) = 0;
};

/// \internal
/// \interface ISNMPManager
/// \ingroup SNMP
/// \brief Handle SNMP settings.
#define ISNMPManager_IID \
{ 0x0738D823, 0xAF94, 0x4F89, {0x9F, 0x26, 0xED, 0xB2, 0xE9, 0x6C, 0x64, 0x33} }

class HE_NO_VTABLE ISNMPManager : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(ISNMPManager_IID);

	/// Get the authentication password.
	HE_IMETHOD GetAuthenticationPassword(/*out*/ Helium::HEBSTR* pbstrAuthenticationPassword) = 0;
	/// Set the authentication password.
	HE_IMETHOD SetAuthenticationPassword(/*in*/ Helium::HEBSTR bstrAuthenticationPassword) = 0;
	/// Get the privacy password.
	HE_IMETHOD GetPrivacyPassword(/*out*/ Helium::HEBSTR* pbstrPrivacyPassword) = 0;
	/// Set the privacy password.
	HE_IMETHOD SetPrivacyPassword(/*in*/ Helium::HEBSTR bstrPrivacyPassword) = 0;
};
...
public:
	...
	/// \param flags Packet header flags.
	/// \param mst Packet header status.
	/// \param pData Pointer to the packet.
	/// \param cbData The number of bytes in the packet.
	/// \param pID Pointer to a variable that receives the ProtoSpec instance ID.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER One of the pointers is invalid.
	/// \remarks None
	HE_IMETHOD GetPacketProtoSpec(/*in*/ TMediaType mt, /*in*/ TMediaSubType mst,
		/*in*/ UInt32 flags, /*in*/ UInt32 status,
		/*in*/ const UInt8* pData, /*in*/ UInt32 cbData, /*out*/ UInt32* pID) = 0;
...
public:
	...
	/// Set the ProtoSpecs mode: XML or native.
	/// \param mode: 0=XML, 1=native.
	/// \retval HE_S_OK Success
	...
	/// \param pData Pointer to the packet.
	/// \param cbData The number of bytes in the packet.
	/// \param pID Pointer to a variable that receives the ProtoSpec ID.
	...
	HE_IMETHOD GetPacketProtoSpec(/*in*/ TMediaType mt, /*in*/ TMediaSubType mst,
		/*in*/ UInt32 flags, /*in*/ UInt32 status,
		/*in*/ const UInt8* pData, /*in*/ UInt32 cbData, /*out*/ UInt32* pID,
		/*out*/ PacketLayerInfo* payLayers, /*in,out*/ UInt32* pnLayers) = 0;
	/// Set the protocol translations.
	/// \param inTranslations Pointer to array of ProtoSpecs::SProtocolTranslation structs
	/// \param inCount Number of SProtocolTranslation elements
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	HE_IMETHOD SetProtocolTranslations(/*in*/ void* inTranslations, /*in*/ UInt32 inCount) = 0;
	/// Get the protocol translations.
	/// \param outTranslations Pointer to array of ProtoSpecs::SProtocolTranslation structs
	/// \param ioCount In: Number of elements allocated; Out: Number of translations
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	HE_IMETHOD GetProtocolTranslations(/*out*/ void* outTranslations, /*in,out*/ UInt32* ioCount) = 0;
};

/// \interface IProtoSpecs3
/// \ingroup ProtoSpecs
/// \brief ProtoSpec access routines.
///
/// This interface is implemented by the OmniPeek console and OmniEngine and
/// provides access to ProtoSpecs.
#define IProtoSpecs3_IID \
{ 0x0362FE28, 0x9CC0, 0x4536, {0xBB, 0x8B, 0x13, 0x5B, 0xD0, 0x5D, 0xAD, 0xDA} }

class HE_NO_VTABLE IProtoSpecs3 : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IProtoSpecs3_IID);

	/// Get the ProtoSpec ID count.
	/// \param pulCount The ProtoSpec ID count.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	HE_IMETHOD GetPSIDCount(/*out*/ UInt16* pulCount) = 0;
	/// Get the list of ProtoSpec IDs.
	/// \param pulIDs List of ProtoSpec IDs.
	/// \param pulCount In: The allocated count of pulIDs, Out: The count of ProtoSpec IDs returned in pulIDs.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	HE_IMETHOD GetPSIDArray(/*out*/ UInt16* pulIDs, /*in,out*/ UInt16* pulCount) = 0;
	/// Determine whether "native" ProtoSpecs is enabled.
	/// \param pbEnabled BOOL.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	...
	/// \remarks None
	HE_IMETHOD GetShortName(/*in*/ UInt32 ulID, /*out*/ Helium::HEBSTR* pbstrName) = 0;
	/// Get the ProtoSpec Instance ID count for a ProtoSpec ID.
	/// \param ulID The ProtoSpec ID.
	/// \param pulCount The count of ProtoSpec Instance IDs.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	/// \remarks None
	HE_IMETHOD GetPSInstanceCount(/*in*/ UInt16 ulID, /*out*/ UInt16* pulCount) = 0;
	/// Check if the ProtoSpec Instance ID is valid.
	/// \param ulID The ProtoSpec Instance ID.
	/// \param pbValid Whether the ProtoSpec Instance ID is valid.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	/// \remarks None
	HE_IMETHOD IsValidInstance(/*in*/ UInt32 ulID, /*out*/ BOOL* pbValid) = 0;
};

/// \interface IProtoSpecs4
/// \ingroup ProtoSpecs
/// \brief ProtoSpec access routines.
///
/// This interface is implemented by the OmniPeek console and OmniEngine and
/// provides access to ProtoSpecs.
#define IProtoSpecs4_IID \
{ 0x51D028B2, 0xEF75, 0x4F1C, {0x96, 0xF3, 0x2A, 0x18, 0x27, 0x38, 0x71, 0xAE} }

class HE_NO_VTABLE IProtoSpecs4 : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IProtoSpecs4_IID);

	/// Find a ProtoSpec ID by short name.
	/// \param bstrName A Helium::HEBSTR containing the short name of the ProtoSpec.
	/// \param pulID Pointer to a variable that receives the ProtoSpec instance ID.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	/// \remarks None
	HE_IMETHOD FindByShortName(/*in*/ Helium::HEBSTR bstrName, /*out*/ UInt32* pulID) = 0;
	/// Find a ProtoSpec ID by long name.
	/// \param bstrName A Helium::HEBSTR containing the long name of the ProtoSpec.
	/// \param pulID Pointer to a variable that receives the ProtoSpec instance ID.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	/// \remarks None
	HE_IMETHOD FindByLongName(/*in*/ Helium::HEBSTR bstrName, /*out*/ UInt32* pulID) = 0;
	/// Find a ProtoSpec instance ID.
	/// \param bstrPath A Helium::HEBSTR containing the path of the ProtoSpec.
	/// \param pulID Pointer to a variable that receives the ProtoSpec instance ID.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	/// \remarks None
	HE_IMETHOD FindInstance(/*in*/ Helium::HEBSTR bstrPath, /*out*/ UInt32* pulID) = 0;
	/// Check if ProtoSpec ID is valid.
	/// \param inID The ProtoSpec ID.
	/// \param pbValid Whether the ProtoSpec ID is valid.
	/// \retval HE_S_OK Success
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER The pointer is invalid.
	/// \remarks None
	HE_IMETHOD IsValidID(/*in*/ UInt16 ulID, /*out*/ BOOL* pbValid) = 0;
};
...
/// Module that needs to display information in the Summary column of
/// OmniPeek's packet list.
#define ISummarizePacket2_IID \
{ 0x9C7C1A4B, 0xEBF4, 0x4F0E, {0xB7, 0x8B, 0x57, 0x12, 0x05, 0x6E, 0x59, 0x20} }

class HE_NO_VTABLE ISummarizePacket2 : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(ISummarizePacket2_IID);
	...
	/// message is displayed. In this case, the console displays the information corresponding
	/// to the highest layer.
	HE_IMETHOD SummarizePacketPlugin(/*in*/ IPacket* pPacket, /*out*/ Helium::HEBSTR* pbstrSummary, /*out*/ Helium::HEBSTR* pbstrPluginName,
		/*in,out*/ UInt32* pColor, /*in,out*/ PeekSummaryLayer* pLayer) = 0;
};
...
/// \see https://learn.microsoft.com/en-us/cpp/error-messages/compiler-warnings/c5054?view=msvc-170
enum PeekCaptureStatus
{
	/// Idle.
	peekCaptureStatusIdle = peekCaptureStateIdle,
	/// Idle - waiting to start trigger.
	peekCaptureStatusIdleStartActive = peekCaptureStateIdle | static_cast<int>(peekTriggerStateStartActive),
	/// Idle - with a stop trigger active.
	peekCaptureStatusIdleStopActive = peekCaptureStateIdle | static_cast<int>(peekTriggerStateStopActive),
	/// Idle - waiting to start trigger with a stop trigger active.
	peekCaptureStatusIdleStartActiveStopActive = peekCaptureStateIdle | static_cast<int>(peekTriggerStateStartActive) | static_cast<int>(peekTriggerStateStopActive),
	/// Capturing - waiting on a start trigger.
	peekCaptureStatusWaitStart = peekCaptureStateCapturing | static_cast<int>(peekTriggerStateStartActive),
	/// Capturing - waiting on a start trigger with a stop trigger active.
	peekCaptureStatusWaitStartStopActive = peekCaptureStateCapturing | static_cast<int>(peekTriggerStateStartActive) | static_cast<int>(peekTriggerStateStopActive),
	/// Capturing packets.
	peekCaptureStatusCapturing = peekCaptureStateCapturing,
	/// Capturing packets with a stop trigger active.
	peekCaptureStatusCapturingStopActive = peekCaptureStateCapturing | static_cast<int>(peekTriggerStateStopActive)
};
...
/// \ingroup Capture
/// \brief Hardware settings in a capture template.
/// \see HardwareConfig
#define IHardwareConfig_IID \
{ 0x731E2E27, 0x7E8C, 0x4F54, {0xBC, 0xE1, 0xB0, 0xD8, 0xDB, 0xAB, 0x97, 0x0F} }

class HE_NO_VTABLE IHardwareConfig : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IHardwareConfig_IID);

	/// Get a hardware profile ID by index.
	HE_IMETHOD GetItem(/*in*/ SInt32 lIndex, /*out*/ Helium::HeID* pID) = 0;
	/// Get the count of hardware profile IDs.
	HE_IMETHOD GetCount(/*out*/ SInt32* pnCount) = 0;
	/// Add a hardware profile ID.
	HE_IMETHOD Add(/*in*/ const Helium::HeID& id) = 0;
	/// Remove a hardware profile ID.
	HE_IMETHOD Remove(/*in*/ const Helium::HeID& id) = 0;
};
...
public:
	...
	/// Determines if any of the captures are using the adapter.
	HE_IMETHOD UsingAdapter(/*in*/ IAdapter* pAdapter, /*out*/ BOOL* pbInUse) = 0;
};
...
/// \brief Basic adapter interface.
/// \see ICapturePackets, ISendPackets, coclass NdisAdapter, coclass ReplayAdapter
#define IAdapter2_IID \
{ 0x2A79D60A, 0x555A, 0x4B56, {0x8F, 0xED, 0xED, 0x0E, 0x21, 0xF4, 0xDD, 0x24} }

class HE_NO_VTABLE IAdapter2 : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IAdapter2_IID);

	/// Add a capture reference.
	HE_IMETHOD AddCaptureRef(/*in*/ IPeekCapture* pPeekCapture) = 0;
	/// Remove a capture reference.
	HE_IMETHOD ReleaseCaptureRef(/*in*/ IPeekCapture* pPeekCapture) = 0;
};
...
/// \internal
/// \enum CaptureTemplateType
enum CaptureTemplateType
{
	captureTemplateTypeUnknown,	///< Initial state - unknown
	captureTemplateTypeDefault,	///< Default template
	captureTemplateTypeUser		///< User defined template
};


/// \internal
/// \interface ICaptureTemplateItem2
/// \ingroup Capture
#define ICaptureTemplateItem2_IID \
{ 0x51DD09D7, 0xE77B, 0x4B6F, {0xB0, 0xFC, 0x79, 0x2A, 0x99, 0x2B, 0xAF, 0xDD} }

class HE_NO_VTABLE ICaptureTemplateItem2 : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(ICaptureTemplateItem2_IID);

	HE_IMETHOD GetTemplateType(/*out*/ CaptureTemplateType* pType) = 0;
	HE_IMETHOD SetTemplateType(/*in*/ CaptureTemplateType newType) = 0;
};
...
/// \internal
/// \interface ICaptureTemplateCollection2
/// \ingroup Capture
#define ICaptureTemplateCollection2_IID \
{ 0xD267C00A, 0xA581, 0x405A, {0xAA, 0xD6, 0x31, 0xBC, 0x21, 0x99, 0xBA, 0xCE} }

class HE_NO_VTABLE ICaptureTemplateCollection2 : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(ICaptureTemplateCollection2_IID);

	HE_IMETHOD IsTyped(/*out*/ BOOL* pbTyped) = 0;
	HE_IMETHOD SetTyped(/*in*/ BOOL bTyped) = 0;
};
...
public:
	...
	HE_IMETHOD SyncFile(/*in*/ Helium::HEBSTR bstrFile, /*in*/ Helium::HEBSTR bstrOwner) = 0;
};
...
#define PEEK_E_FILEVIEW_INVALID_SEARCH			((HeResult)	0x80040211L)
	...
	/// Record forensic search in database.
	HE_IMETHOD Record(/*in*/ const char* strQuery, /*in*/ Helium::HEBSTR bstrOwner) = 0;
};

/// \interface IDistributedForensicSearch
#define IDistributedForensicSearch_IID \
{ 0x6190CEC2, 0x9A66, 0x4B9A, {0xAB, 0xDC, 0xE4, 0x4C, 0xF1, 0xA1, 0x54, 0x34} }

class HE_NO_VTABLE IDistributedForensicSearch : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IDistributedForensicSearch_IID);
...
/// \internal
/// \interface IDecryptionKey
/// \ingroup Decryption
/// \brief Decryption key.
/// \see coclass DecryptionKey
#define IDecryptionKey_IID \
{ 0x01C5C315, 0xF448, 0x4981, {0xB5, 0x9F, 0x62, 0xF9, 0x68, 0x53, 0x71, 0x72} }

class HE_NO_VTABLE IDecryptionKey : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IDecryptionKey_IID);

	/// Get the decryption key ID.
	HE_IMETHOD GetID(/*out*/ Helium::HeID* pID) = 0;
	/// Set the decryption key ID.
	HE_IMETHOD SetID(/*in*/ const Helium::HeID& id) = 0;
	// Get the certificate.
	HE_IMETHOD GetCertificate(/*out*/ char** ppCertificateData, /*out*/ UInt32* pnCertificateLength) = 0;
	// Set the certificate.
	HE_IMETHOD SetCertificate(/*in*/ const char* pCertificateData, /*in*/ const UInt32 nCertificateLength) = 0;
	/// Get the name.
	HE_IMETHOD GetName(/*out*/ Helium::HEBSTR* pbstrName) = 0;
	/// Set the name.
	HE_IMETHOD SetName(/*in*/ Helium::HEBSTR bstrName) = 0;
	/// Get the password.
	HE_IMETHOD GetPassword(/*out*/ Helium::HEBSTR* pbstrPassword) = 0;
	/// Set the password.
	HE_IMETHOD SetPassword(/*in*/ Helium::HEBSTR bstrPassword) = 0;
	/// Determine if the private key is password protected.
	HE_IMETHOD IsPasswordProtected(/*out*/ BOOL* pPasswordProtected) = 0;
	/// Set if the private key is password protected.
	HE_IMETHOD SetPasswordProtected(/*in*/ const BOOL bPasswordProtected) = 0;
	// Get the private key.
	HE_IMETHOD GetPrivateKey(/*out*/ char** ppPrivateKeyData, /*out*/ UInt32* pnPrivateKeyLength) = 0;
	// Set the private key.
	HE_IMETHOD SetPrivateKey(/*in*/ const char* pPrivateKeyData, /*in*/ const UInt32 nPrivateKeyLength) = 0;
};

/// \internal
/// \interface IDecryptionKeyManager
/// \ingroup Decryption
/// \brief Decryption key management.
/// \see coclass DecryptionKeyManager
#define IDecryptionKeyManager_IID \
{ 0xDC501942, 0x1875, 0x490D, {0xA7, 0x03, 0x99, 0xB5, 0x6D, 0x34, 0x57, 0x96} }

class HE_NO_VTABLE IDecryptionKeyManager : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IDecryptionKeyManager_IID);

	/// Load the decryption keys.
	HE_IMETHOD Load() = 0;
	/// Save the decryption keys.
	HE_IMETHOD Save() = 0;
	/// Add decryption key.
	HE_IMETHOD AddDecryptionKey(/*in*/ IDecryptionKey* pDecryptionKey) = 0;
	/// Get the decryption key count.
	HE_IMETHOD GetDecryptionKeyCount(/*out*/ UInt32* pnCount) = 0;
	/// Get the decryption key by index.
	HE_IMETHOD GetDecryptionKey(/*in*/ const UInt32 nIndex, /*out*/ IDecryptionKey** ppDecryptionKey) = 0;
	/// Get the decryption key by key.
	HE_IMETHOD GetDecryptionKey(/*in*/ const Helium::HeID& id, /*out*/ IDecryptionKey** ppDecryptionKey) = 0;
	/// Set the decryption key name.
	HE_IMETHOD SetDecryptionKeyName(/*in*/ const Helium::HeID& id, /*in*/ Helium::HEBSTR bstrName) = 0;
	/// Remove decryption key.
	HE_IMETHOD RemoveDecryptionKey(/*in*/ const Helium::HeID& id) = 0;
};

/// \interface IDecryptionKeyHandler
/// \ingroup DecryptionKeyHandler
/// \brief Handles decryption keys from an IDecryptionKeyProvider
#define IDecryptionKeyHandler_IID \
{ 0xCF3A0AA0, 0xA89E, 0x44F6, {0x88, 0xA2, 0x6D, 0xE7, 0x92, 0xC3, 0xDF, 0xD9} }

class HE_NO_VTABLE IDecryptionKeyHandler : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IDecryptionKeyHandler_IID);

	/// Handle the addition of a decryption key.
	HE_IMETHOD HandleAddDecryptionKey(/*in*/ IDecryptionKey* pDecryptionKey) = 0;
	/// Handle the removal of a decryption key.
	HE_IMETHOD HandleRemoveDecryptionKey(/*in*/ const Helium::HeID& id) = 0;
};

/// \interface IDecryptionKeyProvider
/// \ingroup Decryption
/// \brief Provides decryption keys to IDecryptionKeyHandlers.
#define IDecryptionKeyProvider_IID \
{ 0x3B64922E, 0x9F52, 0x4077, {0xA0, 0x17, 0x38, 0xD9, 0x31, 0x6F, 0x7F, 0x0E} }

class HE_NO_VTABLE IDecryptionKeyProvider : public Helium::IHeUnknown
{
public:
	HE_DEFINE_STATIC_IID_ACCESSOR(IDecryptionKeyProvider_IID);

	/// Add a decryption key handler.
	HE_IMETHOD AddDecryptionKeyHandler(/*in*/ IDecryptionKeyHandler* pDecryptionKeyHandler) = 0;
	/// Remove a decryption key handler.
	HE_IMETHOD RemoveDecryptionKeyHandler(/*in*/ IDecryptionKeyHandler* pDecryptionKeyHandler) = 0;
};
...
#define AdapterList_CID \
{ 0x3013F990, 0xE9F2, 0x4ACF, {0x8B, 0xF1, 0x7E, 0xD3, 0x8B, 0x10, 0x87, 0xF9} }
...
#define NapatechHardwareChannelFilterValue_CID \
{ 0xDBE5EE62, 0x70ED, 0x4EC0, {0x80, 0xA4, 0xA8, 0xD9, 0x16, 0xF8, 0xB3, 0xD5} }
...
#define MultiFilePacketBuffer3_CID \
{ 0x06CEC855, 0x4E42, 0x4CBC, {0xBB, 0x02, 0xCA, 0x9F, 0x15, 0x55, 0x0A, 0xCD} }

#define MultiFilePacketBuffer5_CID \
{ 0x1C7B0584, 0x232A, 0x452E, {0x86, 0x19, 0x7F, 0x4B, 0xFD, 0x18, 0x0E, 0x1E} }
...
#define HardwareConfig_CID \
{ 0x6F3377D6, 0xFBD7, 0x4CBD, {0xA7, 0x40, 0x2E, 0xAE, 0x63, 0xDB, 0xF6, 0x39} }
...
#define DistributedForensicSearch_CID \
{ 0x571C1CBC, 0x21C0, 0x4678, {0x8F, 0x6D, 0x5D, 0xFB, 0x9F, 0xDF, 0x2C, 0xDE} }

#define MediaInfo_CID \
{ 0x87FEDA06, 0xD1B6, 0x425C, {0x84, 0x11, 0x0D, 0xD1, 0xBD, 0x89, 0xFC, 0x37} }

#define ProtocolTranslationsManager_CID \
{ 0x6F4A9374, 0xADA8, 0x4302, {0x84, 0xED, 0xAA, 0xE0, 0x28, 0x88, 0x6B, 0xE7} }

#define LicenseManager_CID \
{ 0x1C13A866, 0xAFEB, 0x438C, {0x97, 0x27, 0x8A, 0x61, 0xC5, 0x49, 0x03, 0x87} }

#define DecryptionKey_CID \
{ 0x8DF5F807, 0x78A1, 0x490B, {0x9C, 0x4F, 0x08, 0x23, 0x8E, 0x4D, 0xA5, 0x39} }

#define DecryptionKeyManager_CID \
{ 0x520B42EE, 0xC8D2, 0x49AC, {0xB0, 0x1C, 0xD9, 0x89, 0x6D, 0x55, 0x36, 0xA3} }

#define SNMPManager_CID \
{ 0x093FF2D4, 0x2CB5, 0x4B9A, {0xA1, 0x3E, 0xE3, 0x12, 0x75, 0x30, 0xCB, 0x28} }
