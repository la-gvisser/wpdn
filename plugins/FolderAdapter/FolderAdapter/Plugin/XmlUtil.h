...
HeResult	PrettyFormatXml( Xml::IXMLDOMDocument* pDoc, const wchar_t* pszIndent = nullptr );
...
void GetElement( Xml::IXMLDOMElement* pElem, Q** ppObj )
{
	...
	Helium::HeCID	clsid;
	Peek::ThrowIf( !GetAttribute( pElem, L"clsid", clsid ) );

	// Get the XML doc.
	CHePtr<Xml::IXMLDOMDocument>	spXmlDoc;
	Peek::ThrowIfFailed( pElem->get_ownerDocument( &spXmlDoc.p ) );

	// Create the object.
	CHePtr<Q>	spObj;
	Peek::ThrowIfFailed( spObj.CreateInstance( clsid ) );

	// Load it.
	CHePtr<Helium::IHePersistXml>	spPersistXml;
	Peek::ThrowIfFailed( spObj->QueryInterface( &spPersistXml.p ) );
	Peek::ThrowIfFailed( spPersistXml->Load( spXmlDoc, pElem ) );

	// Return it.
	Peek::ThrowIfFailed( spObj.CopyTo( ppObj ) );
}
...
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, Xml::IXMLDOMElement** ppElem = nullptr );

// AddChildElement - add a child object that supports IPersistXml
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, Helium::IHeUnknown* pObj, Xml::IXMLDOMElement** ppElem = nullptr,
			bool bWriteClsidAttribute = true, bool bClearDirty = true );

// AddChildElement - general purpose
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, const HeLib::CHeVariant& varVal, Xml::IXMLDOMElement** ppElem = nullptr );

// AddChildElement - wrappers for specific types
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, const HeLib::CHeBSTR& bstrVal, Xml::IXMLDOMElement** ppElem = nullptr );
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, const std::wstring& strVal, Xml::IXMLDOMElement** ppElem = nullptr );
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, const std::string& strVal, Xml::IXMLDOMElement** ppElem = nullptr );
#if defined(__ATLSTR_H__) || defined(__AFXSTR_H__)
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, const CString& bstrVal, Xml::IXMLDOMElement** ppElem = nullptr );
#endif /* defined(__ATLSTR_H__) || defined(__AFXSTR_H__) */
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, const wchar_t* pszVal, Xml::IXMLDOMElement** ppElem = nullptr );
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, const char* pszVal, Xml::IXMLDOMElement** ppElem = nullptr );
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, SInt8 cVal, Xml::IXMLDOMElement** ppElem = nullptr );
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, UInt8 bVal, Xml::IXMLDOMElement** ppElem = nullptr );
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, SInt16 iVal, Xml::IXMLDOMElement** ppElem = nullptr );
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, UInt16 uiVal, Xml::IXMLDOMElement** ppElem = nullptr );
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, SInt32 lVal, Xml::IXMLDOMElement** ppElem = nullptr );
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, UInt32 ulVal, Xml::IXMLDOMElement** ppElem = nullptr );
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, SInt64 llVal, Xml::IXMLDOMElement** ppElem = nullptr );
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, UInt64 ullVal, Xml::IXMLDOMElement** ppElem = nullptr );
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, bool boolVal, Xml::IXMLDOMElement** ppElem = nullptr );
#ifndef OPT_64BITINTTYPES
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, int intVal, Xml::IXMLDOMElement** ppElem = nullptr );
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, unsigned int uintVal, Xml::IXMLDOMElement** ppElem = nullptr );
#endif /* OPT_64BITINTTYPES */
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, double dblVal, Xml::IXMLDOMElement** ppElem = nullptr );
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, const Helium::HeID& guidVal, Xml::IXMLDOMElement** ppElem = nullptr );
void	AddChildElement( Xml::IXMLDOMDocument* pDoc, Xml::IXMLDOMNode* pNode,
			const wchar_t* pszName, const UInt8* pData, size_t nDataLen, Xml::IXMLDOMElement** ppElem = nullptr );
	...
	Xml::IXMLDOMElement**	ppElem )
{
...

	{
		...
		{
			HeLib::HeThrowIfNotOK( pNode->removeChild( spOldElement, nullptr ) );
