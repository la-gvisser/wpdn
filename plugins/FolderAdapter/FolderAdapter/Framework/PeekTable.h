...
//	PeekTable.h
// =============================================================================
//	Copyright (c) 2012-2015 Savvius, Inc. All rights reserved.
...
public:
	...
	bool		IsNotValid() const { return (m_spColumn.get() == nullptr); }
	bool		IsValid() const { return (m_spColumn.get() != nullptr); }
...
public:
	...
	bool		IsNotValid() const { return (m_spCols.get() == nullptr); }
	bool		IsValid() const { return (m_spCols.get() != nullptr); }
...
public:
	...
	bool		IsNotValid() const { return (m_spRow.get() == nullptr); }
	bool		IsValid() const { return (m_spRow.get() != nullptr); }
...
public:
	...
	bool		IsNotValid() const { return (m_spRows.get() == nullptr); }
	bool		IsValid() const { return (m_spRows.get() != nullptr); }
...
public:
	...
	bool		IsNotValid() const { return (m_spDataTable.get() == nullptr); }
	bool		IsValid() const { return (m_spDataTable.get() != nullptr); }
