...
#define kPluginName				L"FolderAdapterOE"
#define kTag_ConfigFileName		L"FolderAdapterOE.xml"
#define kTag_Options			L"Options"

HeID		GUID_RemoteAdapter = CRemoteAdapter_CID;
CPeekString	g_strRemoteAdapterName( L"FolderAdapterOE" );
	...
	IHeUnknown*	pSnapshot )
{
	...
	m_OmniAdapter.OnUpdateSummaryStats( snapshot );
