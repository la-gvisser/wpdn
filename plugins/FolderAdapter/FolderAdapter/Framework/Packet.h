...
public:
	...
	bool		IsNotValid() const { return (m_spLayers.get() == nullptr); }
	bool		IsValid() const { return (m_spLayers.get() != nullptr); }
...
public:
	...
	bool			IsDataOwner() const { return (m_spData.get() != nullptr); }
	...
	bool			IsNotValid() const { return (m_spPacket.get() == nullptr); }
	bool			IsValid() const { return (m_spPacket.get() != nullptr); }
	bool			IsWAN() const {
		int	bResult = FALSE;
		if ( IsValid() ) {
