...
//	const UInt32 OMNI_ADMCMD_GET_COMMAND_LIST					= 522;		// Obsolete, use OMNI_GET_COMMAND_LIST
	...
	const UInt32 OMNI_GET_APOLLO_NETWORKS						= 1000;
	const UInt32 OMNI_SET_APOLLO_NETWORKS						= 1001;
	const UInt32 OMNI_GET_APOLLO_FILTERS						= 1002;
	const UInt32 OMNI_SET_APOLLO_FILTERS						= 1003;
	const UInt32 OMNI_GET_APOLLO_STATS							= 1004;
	const UInt32 OMNI_GET_APOLLO_ALERTS							= 1005;
	const UInt32 OMNI_SET_APOLLO_ALERTS							= 1006;
	const UInt32 OMNI_GET_APOLLO_ALERTSLOG						= 1007;
	const UInt32 OMNI_GET_APOLLO_CONFIG							= 1008;
	const UInt32 OMNI_SET_APOLLO_CONFIG							= 1009;
