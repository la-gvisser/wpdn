...
public:
	...
	HE_IMETHOD FilterFile(/*in*/ UInt32 nSessionID, /*in*/ UInt64 nStartTimestamp, /*in*/ UInt64 nStopTimestamp,
...
///
/// Optional interface used by the OmniEngine. This interface needs to filter capture sessions captured by the engine.
...
public:
	...
	/// \retval HE_E_FAIL Error
	/// \retval HE_E_INVALID_POINTER One of the pointers is invalid
	/// \remarks This interface should not be implemented if the OmniEngine does not need to filter capture sessions.
...
#define ApolloStreamHandler_CID \
{ 0x5F052FDC, 0x11A7, 0x409A, {0x90, 0x8F, 0x66, 0x0C, 0xCE, 0xF9, 0x66, 0x87} }
