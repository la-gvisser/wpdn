...
public:
	...
	void	UpdateSummaryStats( IHeUnknown* inSnapshot ) {
		if ( IsValid() ) {
			Peek::ThrowIfFailed( m_spUpdateSummaryStats->UpdateSummaryStats( inSnapshot ) );
		}
	}
};
...
public:
	...
	bool	StartPacketProvider() {
		HeLib::CHePtr<IPacketHandler> safeHandle( m_spHandler );
